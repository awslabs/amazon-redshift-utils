...
| table_inspector.sql | Table Analysis based on content in http://docs.aws.amazon.com/redshift/latest/dg/c_analyzing-table-design.html. Complements table_info.sql |
