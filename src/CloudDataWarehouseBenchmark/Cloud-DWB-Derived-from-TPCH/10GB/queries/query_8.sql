...
from
	lineitem
where
	l_shipdate <= dateadd(day, -63, cast('1998-12-01' as date)) 
group by
	l_returnflag,
	l_linestatus
order by
...
with revenue as (
		...
		where
			...
			and l_shipdate < dateadd(month, 3, cast('1994-02-01' as date)) 
		group by
			l_suppkey
)
select /* TPC-H Q15 */
...
where
	...
	and l_shipdate < dateadd(month, 1, cast('1995-02-01' as date))
;
