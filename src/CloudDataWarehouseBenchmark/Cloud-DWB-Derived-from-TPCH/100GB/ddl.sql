...
/*
Text files needed to load test data under s3://redshift-downloads/TPC-H/100GB are publicly available. Any valid credentials can be used to access the files.
