...
where
	...
	and o_orderdate < dateadd(month, 3, cast('1996-07-01' as date)) 
	and exists (
		select
			*
		from
...
from
	lineitem
where
	l_shipdate <= dateadd(day, -116, cast('1998-12-01' as date)) 
group by
	l_returnflag,
	l_linestatus
order by
...
where
	...
	and o_orderdate < dateadd(month, 3, cast('1994-06-01' as date))
	and l_returnflag = 'R'
...
where
	...
	and l_shipdate < dateadd(month, 1, cast('1994-11-01' as date))
;
