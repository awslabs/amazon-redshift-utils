...
copy region from 's3://redshift-downloads/TPC-H/2.18/30TB/region/' iam_role default gzip delimiter '|';
copy nation from 's3://redshift-downloads/TPC-H/2.18/30TB/nation/' iam_role default gzip delimiter '|';
