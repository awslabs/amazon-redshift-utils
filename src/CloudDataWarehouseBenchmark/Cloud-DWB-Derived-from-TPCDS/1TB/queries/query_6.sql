...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Ziebach County','Mobile County','Maverick County','Richland County',
                           'Bronx County','Kittitas County','Jefferson Davis Parish','Williamson County')
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2001-03-15' as date) 
 				and dateadd(day,30,cast('2001-03-15' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Gogebic County','Levy County','Mobile County','Mesa County')
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 22244363
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 28508541
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 17213740
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 47995649
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 20609507
            then (select avg(ss_ext_list_price)
                  from store_sales
...
and d_date between '1999-01-11' and 
        dateadd(day,90,cast('1999-01-11' as date))
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Children','Sports','Jewelry') and
          i_class in ('infants','sailing','estate')
         )
      or (i_category in ('Men','Home','Music') and
          i_class in ('shirts','wallpaper','pop') 
        ))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 168 and 168+10
          or ss_coupon_amt between 16247 and 16247+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 125 and 125+10
          or ss_coupon_amt between 9887 and 9887+1000
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,4,7,3,9,12) and
       d_year = 1998 and
       ca_state in ('MS','GA','ID','SC','KS','OH','LA')
 )
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oak Grove'
   ...
   and ib_lower_bound   >=  48003
   and ib_upper_bound   <=  48003 + 50000
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2002-01-14' as date) and dateadd(day,60,cast('2002-01-14' as date))
 and i_manufact_id in (907,198,964,659)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '79000','85163','30346','76576','61790','59398',
                          '85531','27753','56776','69757','14963',
                          '29255','28280','61223','82873','23304',
                          '73433','27652','36214','20833','68494',
                          '58810','89929','22099','85502','64510',
                          '80710','70353','96979','46226','68380',
                          '77215','33089','21744','67794','83041',
                          '46864','57545','64905','31553','97151',
                          '29671','91599','24554','20608','32031',
                          '76379','75948','20658','63960','54770',
                          '59916','55173','27896','94811','35164',
                          '39387','21679','39627','23582','58563',
                          '91919','56358','45235','63266','83675',
                          '78137','64222','67826','80478','92964',
                          '56225','51006','89120','53235','11644',
                          '32308','35081','89726','59522','26549',
                          '37731','48051','71979','52404','75086',
                          '94591','49199','48639','27377','23675',
                          '60152','71355','63779','49396','74339',
                          '11342','57677','49317','32734','76496',
                          '83893','32227','80457','58614','45806',
                          '47821','11478','86881','93155','44450',
                          '46886','25507','77532','32540','67298',
                          '25660','47168','58018','80899','96773',
                          '51215','27258','90681','93590','44598',
                          '19331','22394','57978','37026','24714',
                          '64530','20576','48116','26671','23073',
                          '69327','97514','67855','77107','43473',
                          '12765','84348','42353','74849','90475',
                          '24772','33870','20663','45312','66854',
                          '87200','43466','67553','20531','33383',
                          '62942','45162','29924','85475','26233',
                          '70370','31415','78771','74765','69788',
                          '28400','73828','41875','69608','23075',
                          '36400','18448','82956','26051','30543',
                          '11359','67104','91737','70498','17146',
                          '54674','42011','20724','29094','59495',
                          '60754','81001','18069','31181','79805',
                          '38728','46946','76840','58052','61540',
                          '91703','47661','78482','43561','85567',
                          '94236','26001','58055','28216','22574',
                          '89276','23562','35343','96065','93766',
                          '91272','57380','84547','30912','66938',
                          '97632','32225','64083','48429','71660',
                          '44779','47944','75691','64882','24146',
                          '82146','18274','16420','48260','78290',
                          '64934','81974','57594','30822','49557',
                          '52776','46025','87859','92728','97064',
                          '80258','40668','86948','97959','57317',
                          '41246','77134','62856','64331','46724',
                          '23625','75725','13271','23942','72067',
                          '18520','63059','58214','42357','25474',
                          '24488','43089','73280','77616','49630',
                          '79981','24305','24800','34959','19765',
                          '39594','69749','94066','85278','81068',
                          '30004','72232','22652','76186','60093',
                          '14256','28946','75617','70572','94610',
                          '79354','68605','70147','34806','38298',
                          '98708','57275','92013','65267','73170',
                          '83894','43890','93259','23641','15778',
                          '34367','76771','19200','12217','78842',
                          '49614','19914','79872','20341','62541',
                          '33762','73392','87791','75695','61759',
                          '57019','37702','60948','53714','93551',
                          '16678','20329','71536','31042','74211',
                          '52517','48014','82553','62889','76767',
                          '61757','72838','95974','56698','24376',
                          '75927','67214','31357','24012','72406',
                          '99707','40374','36016','84613','49352',
                          '60115','29297','26856','11843','54154',
                          '51250','27015','98000','72927','38783',
                          '10908','32251','36193','64288','51263',
                          '50446','16554','88198','56412','74555',
                          '64693','45831','97028','53534','62144',
                          '14568','95812','26091','27092','90065',
                          '62859','42783','66769','80933','47301',
                          '73086','31489','95730','16425','84262',
                          '63791','29685','40196','49784','17860',
                          '15055','67150','43933','51748','73879',
                          '52659','61691','81734','81238')
     intersect
      select ca_zip
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-23' as date) 
                  and dateadd(day,30,cast('1999-08-23' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
where 
	...
	and d_date between cast('2001-05-12' as date) 
				and dateadd(day,30,cast('2001-05-12' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('sandy','chartreuse','beige'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 7
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-05-16' as date) and dateadd(day,60,cast('2002-05-16' as date))
 and i_manufact_id in (797,818,982,952)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Grand Isle County','Liberty County','Montcalm County','Randall County','Pottawattamie County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('1999-05-08' as date))
                    and dateadd(day,30,cast ('1999-05-08' as date))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Franklin','Shady Grove','Spring Hill','Spring Valley','Midway') 
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-08','2001-10-08','2001-11-14')))
...
and d_date between '2000-02-06' and 
        dateadd(day,90,cast('2000-02-06' as date))
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('gainsboro','frosted','peach','wheat','purple','brown') and
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('OH', 'MI', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'IN', 'SC')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'VT', 'MO')
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2000-03-09' as date))
...
and cc_county in ('Wadena County','Dauphin County','Pennington County','Walker County',
                  'Marshall County'
)
and exists (select *
