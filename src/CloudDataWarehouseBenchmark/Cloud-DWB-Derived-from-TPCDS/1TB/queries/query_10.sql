...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('1998-02-24' as date))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,9,7,8,10,4) and
       d_year = 1998 and
       ca_state in ('AK','IA','MN','AL','IN','MO','NC')
 )
...
and d_date between '2000-03-22' and 
        dateadd(day,90,cast('2000-03-22' as date))
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 13476 and 13476+28800 
...
where 
	...
	and d_date between cast('2000-01-31' as date) 
				and dateadd(day,30,cast('2000-01-31' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2000-03-09' as date) and dateadd(day,60,cast('2000-03-09' as date))
 and i_manufact_id in (172,190,323,452)
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and i_manufact_id in (772,813,798,897)
 and inv_quantity_on_hand between 100 and 500
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lime','rose','blush','sandy','lavender','pale') and
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 62 and 62+10
          or ss_coupon_amt between 5443 and 5443+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 50 and 50+10
          or ss_coupon_amt between 4189 and 4189+1000
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Springfield'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  9487
   and ib_upper_bound   <=  9487 + 50000
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Montgomery County','Covington County','Oconee County','Fergus County','Webster Parish') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and cc_county in ('Pennington County','Fairfield County','Mobile County','San Miguel County',
                  'Daviess County'
)
and exists (select *
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Walker County','Bronx County','Barrow County','Pennington County',
                           'Jackson County','Fairfield County','Kittitas County','Raleigh County')
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Gage County','Jackson County','Levy County','Bronx County')
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('moccasin','lawn','cyan'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 1
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-02-08','2001-09-09','2001-11-16')))
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Hillcrest','Fairfield')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Women','Home','Electronics') and
          i_class in ('fragrances','lighting','portable')
         )
      or (i_category in ('Men','Books','Sports') and
          i_class in ('pants','travel','fitness') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Pine Grove','Riverview','Mount Vernon','Liberty','Mount Olive') 
...
and d_date between '2002-02-19' and 
        dateadd(day,90,cast('2002-02-19' as date))
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('OH', 'MN', 'KS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'MS', 'CA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MO', 'WA', 'AR')
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 15625418
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2542155
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 29263305
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 177631
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 42701197
            then (select avg(ss_ext_tax)
                  from store_sales
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '30922','50280','22984','45868','40057','92700',
                          '95934','57967','31997','85025','84580',
                          '65051','22295','65440','16300','50002',
                          '62309','57905','31801','70919','63179',
                          '96087','40944','34503','81400','42740',
                          '71196','75696','68400','28982','77749',
                          '18797','42423','63507','42840','95304',
                          '72065','61323','12381','59726','47999',
                          '67428','22490','67050','63376','21156',
                          '57853','94123','15409','80202','79862',
                          '82811','18126','78463','55310','15290',
                          '62829','27767','11681','20704','51635',
                          '87899','34711','31042','51135','21975',
                          '11870','44680','61894','67540','44671',
                          '11053','16613','56491','61712','20321',
                          '27928','34094','31602','19771','64268',
                          '69353','30581','97559','93157','71965',
                          '57317','18104','27503','36930','87605',
                          '68462','91711','68632','36301','36035',
                          '84480','74388','88190','20362','68591',
                          '71174','77123','26838','61991','66197',
                          '38209','39197','32958','45258','32078',
                          '83414','50286','98155','50231','46170',
                          '11252','98760','30266','42757','26438',
                          '46703','41994','99081','36862','96497',
                          '57946','51685','99062','88623','45625',
                          '91376','92790','32141','17182','37515',
                          '53180','95698','91928','25143','60092',
                          '19186','57330','98941','65283','26329',
                          '12731','53184','69819','29119','75460',
                          '19001','79601','50359','21154','19878',
                          '81065','62367','34922','46212','77202',
                          '89420','58217','82163','39727','12203',
                          '18879','52469','43608','60276','68325',
                          '31992','27129','68534','67883','66693',
                          '61176','23379','56606','10385','87653',
                          '99153','87115','10218','51438','47623',
                          '75788','98847','66262','45018','66990',
                          '18049','54604','58751','11445','94887',
                          '89024','12892','72555','55188','53646',
                          '12097','25051','90157','92754','80023',
                          '76793','34077','21569','75807','17166',
                          '68348','60748','14883','75990','20386',
                          '52138','96001','16881','24733','26375',
                          '57842','48469','13341','62532','55046',
                          '92962','77476','82974','95076','98684',
                          '35441','38239','56961','84638','97125',
                          '81982','23875','79316','94658','94862',
                          '77465','46911','83653','29228','16946',
                          '48814','79063','29646','21437','52526',
                          '34346','81455','24465','53852','22324',
                          '87032','11830','23517','38185','63273',
                          '14178','32219','12222','51879','75611',
                          '49076','64203','54536','69176','52179',
                          '54773','73951','19973','39608','57336',
                          '30486','35870','20830','13361','70036',
                          '53453','80375','35547','67928','25197',
                          '73009','52713','53311','77716','87639',
                          '23464','96961','86748','89040','44861',
                          '22860','14342','57128','37727','13288',
                          '75854','71951','52384','64349','50748',
                          '83254','98515','70878','54233','33059',
                          '96215','10256','81466','82223','64290',
                          '63860','96411','31970','97094','63789',
                          '99370','14213','69292','10896','51472',
                          '91597','66718','77767','78434','16566',
                          '79160','85882','87844','28879','19225',
                          '82839','77664','83422','95995','59313',
                          '95808','57900','76662','84911','51285',
                          '34017','55724','69383','51228','28640',
                          '71598','89479','13495','50201','68373',
                          '18069','14951','23316','50312','16552',
                          '44800','48606','71819','42452','24213',
                          '81404','44149','90539','79311','68940',
                          '41226','44200','87420','39273','94690',
                          '40100','89269','94921','20070','59073',
                          '39748','65455','33749','63821','71709',
                          '46498','30151','63624','94069','76917',
                          '15868','82965','98255','72246','19217',
                          '53665','74202','14585','51975')
     intersect
      select ca_zip
