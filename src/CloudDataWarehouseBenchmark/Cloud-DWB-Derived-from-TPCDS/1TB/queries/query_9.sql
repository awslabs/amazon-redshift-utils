...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-10' as date) 
                  and dateadd(day,14,cast('2000-08-10' as date))
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MI', 'AL', 'ID')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'RI', 'AR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'NC', 'WV')
...
and d_date between '1999-03-13' and 
        dateadd(day,90,cast('1999-03-13' as date))
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Pennington County','Maverick County','Mobile County','Raleigh County',
                           'Williamson County','Gage County','Fairfield County','Ziebach County')
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('1998-02-06' as date))
                    and dateadd(day,30,cast ('1998-02-06' as date))
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 38215218
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 5887994
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 12401907
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 12726249
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 30242569
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
where 
	...
	and d_date between cast('1998-06-02' as date) 
				and dateadd(day,30,cast('1998-06-02' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '1998-01-15' and 
        dateadd(day,90,cast('1998-01-15' as date))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 140 and 140+10
          or ss_coupon_amt between 6138 and 6138+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 125 and 125+10
          or ss_coupon_amt between 17999 and 17999+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 116 and 116+10
          or ss_coupon_amt between 2346 and 2346+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 83 and 83+10
          or ss_coupon_amt between 11967 and 11967+1000
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2001-03-13' as date) 
 				and dateadd(day,30,cast('2001-03-13' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-02' as date) 
                  and dateadd(day,30,cast('2001-08-02' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('1999-04-21' as date) and dateadd(day,60,cast('1999-04-21' as date))
 and i_manufact_id in (90,953,293,875)
...
and cc_county in ('Franklin Parish','Dauphin County','Fairfield County','Pennington County',
                  'Williamson County'
)
and exists (select *
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  ...
  ca_county in ('Fremont County','Malheur County','Goodhue County','Dodge County','Fannin County') and
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,8,1,6,2,11) and
       d_year = 2001 and
       ca_state in ('MS','TN','PA','GA','NY','MN','WA')
 )
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-08' as date) 
                  and dateadd(day,30,cast('2002-08-08' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Buena Vista','Franklin')
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1999-05-30' as date))
                and dateadd(day,30,cast ('1999-05-30' as date))
 group by
    w_state,i_item_id
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 26105 and 26105+28800 
...
where 
	...
	and d_date between cast('1999-03-26' as date) 
				and dateadd(day,30,cast('1999-03-26' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Ziebach County','Daviess County','Kittitas County','Richland County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Books','Jewelry','Home') and
          i_class in ('entertainments','custom','paint')
         )
      or (i_category in ('Shoes','Women','Children') and
          i_class in ('mens','swimwear','infants') 
        ))
group by i_category, i_class, i_brand,
 ...
 where i_manufact_id between 721 and 721+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'wheat' or i_color = 'floral') and 
        (i_units = 'Pound' or i_units = 'N/A') and
        (i_size = 'N/A' or i_size = 'economy')
        ) or
        (i_category = 'Women' and
        (i_color = 'indian' or i_color = 'medium') and
        ...
        (i_category = 'Men' and
        (i_color = 'lawn' or i_color = 'ghost') and
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-02-20','2002-10-05','2002-11-16')))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Friendship','Liberty','Spring Valley','Mount Pleasant','Greenwood') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('steel','brown','cornsilk','grey','seashell','sienna') and
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('wheat','almond','saddle'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 7
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-04-24' as date) and dateadd(day,60,cast('1999-04-24' as date))
 and i_manufact_id in (732,921,723,763)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '92244','37333','28071','24783','85708','19753',
                          '34181','38280','67907','52971','31247',
                          '11458','55400','28685','67696','32156',
                          '39576','38232','91595','16935','41407',
                          '96784','32877','94613','12763','30789',
                          '39850','59494','44362','43160','40789',
                          '63087','28105','66097','96082','16315',
                          '80238','48882','47327','17086','87200',
                          '63117','75113','49166','89983','41331',
                          '50810','46486','24455','45425','70965',
                          '46261','69565','14656','88879','32095',
                          '94572','28216','91022','85937','66078',
                          '29826','55310','33734','18226','99692',
                          '61710','69082','34285','51483','96070',
                          '29500','35742','59203','18684','70328',
                          '77634','88701','25860','14975','89176',
                          '15105','83799','58331','63925','27240',
                          '94121','68644','24754','58913','86994',
                          '93032','45342','48868','95002','69838',
                          '29772','16904','68743','97018','82640',
                          '41796','63789','20677','75131','29929',
                          '88612','72337','69733','11939','19136',
                          '53838','26606','38069','45436','29176',
                          '58314','52590','43622','61181','54904',
                          '52486','76432','29829','11137','72980',
                          '87675','55117','12377','54085','63666',
                          '25083','31868','67782','13740','85287',
                          '30795','89978','27185','27123','67315',
                          '97717','40227','27452','43207','80640',
                          '80249','46574','26777','20751','95648',
                          '65495','33663','61655','77376','92366',
                          '46145','99506','34680','85892','42380',
                          '11170','51190','37942','45869','66435',
                          '29546','22836','17947','43048','47407',
                          '34775','53683','87718','75601','77761',
                          '13528','89448','42568','19682','34086',
                          '75463','34919','28448','56950','46976',
                          '76762','22595','76265','49639','41920',
                          '72964','54621','57682','72174','91185',
                          '26451','71105','70396','72205','52246',
                          '29983','74304','69252','74408','27374',
                          '72384','66289','80345','18582','24904',
                          '95903','95902','38988','12038','52236',
                          '14391','28239','39927','58426','22909',
                          '40083','18650','12214','27042','56601',
                          '73762','53432','27088','29633','58633',
                          '63555','73978','95296','98351','90441',
                          '51274','72080','92959','55760','63524',
                          '85530','54771','42032','26858','78693',
                          '28221','39483','57876','95437','94312',
                          '96995','66450','74288','83915','96274',
                          '18025','65527','80200','17327','35707',
                          '52185','27649','12562','11643','93725',
                          '56841','26116','52993','77943','76075',
                          '48487','80041','12401','34277','48738',
                          '57515','46827','34529','88594','49956',
                          '48801','81659','17938','85053','57923',
                          '54577','63463','54906','93384','76190',
                          '89472','83894','46525','38910','25336',
                          '61458','16542','96935','42574','71453',
                          '57248','50858','54020','56486','81275',
                          '28996','97438','12674','66491','67024',
                          '22012','96360','18966','68053','48884',
                          '99191','45443','28883','59798','85689',
                          '28698','43041','34673','48878','75694',
                          '67383','29455','60724','37352','74464',
                          '92258','76444','13735','93655','27235',
                          '51771','83005','97073','91015','47121',
                          '60897','70067','99810','55969','48689',
                          '28697','76013','53661','44243','65063',
                          '37093','22185','57171','32242','44208',
                          '94976','26583','66162','92124','72144',
                          '53763','49849','45687','60144','74941',
                          '29249','86621','41605','74407','96603',
                          '70008','24704','59385','10254','61159',
                          '20257','44453','16496','98551','37872',
                          '56117','67553','15706','98663','49255',
                          '53310','18848','42543','36794','28607',
                          '95592','14060','77234','85985','30181',
                          '27585','59727','67578','90646')
     intersect
      select ca_zip
