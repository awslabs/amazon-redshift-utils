...
and d_date between '2000-02-04' and 
        dateadd(day,90,cast('2000-02-04' as date))
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lavender','blanched','red','linen','bisque','moccasin') and
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Riverside','New Hope','Mount Pleasant','Georgetown','Hopewell') 
...
and cc_county in ('Jefferson Davis Parish','Ziebach County','Mobile County','Dauphin County',
                  'Walker County'
)
and exists (select *
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  ...
  ca_county in ('Scott County','Palo Pinto County','Forrest County','Childress County','Kleberg County') and
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('1999-02-28' as date) and dateadd(day,60,cast('1999-02-28' as date))
 and i_manufact_id in (726,826,898,792)
...
where 
	...
	and d_date between cast('2000-03-29' as date) 
				and dateadd(day,30,cast('2000-03-29' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 6 and 6+10 
             or ss_coupon_amt between 13120 and 13120+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 3023 and 3023+1000
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 2725 and 2725+28800 
...
and d_date between '2001-02-27' and 
        dateadd(day,90,cast('2001-02-27' as date))
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 44638140
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 36841683
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 2754762
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 32184236
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 42481913
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Sports','Music','Men') and
          i_class in ('outdoor','classical','accessories')
         )
      or (i_category in ('Home','Books','Women') and
          i_class in ('bedding','arts','dresses') 
        ))
group by i_category, i_class, i_brand,
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '84997','85824','19214','41539','22117','76594',
                          '19820','80019','22310','50946','87707',
                          '17312','49573','19986','73101','15545',
                          '13379','33809','77234','47279','40270',
                          '49590','35186','11226','31866','69399',
                          '26164','74750','12968','38819','86748',
                          '37462','66575','86992','55867','79254',
                          '27689','26136','60829','87590','68152',
                          '32579','63529','22944','20489','25565',
                          '73858','82039','79705','47905','33715',
                          '12328','45223','75896','15116','14440',
                          '59707','59675','54574','33281','43758',
                          '60243','54118','31763','57905','10123',
                          '92810','26705','78851','74851','31303',
                          '87664','72312','56250','67525','57833',
                          '46419','89095','69493','98055','57381',
                          '16586','49882','96373','12716','48969',
                          '94855','42346','22328','64674','33981',
                          '69197','56314','67734','28466','27684',
                          '83694','64998','46497','78478','30453',
                          '16236','97687','23851','56399','20336',
                          '74006','16984','21741','35886','45252',
                          '14931','58987','83316','86078','56354',
                          '78097','70888','74248','87455','49375',
                          '78365','74782','68726','85749','22109',
                          '65309','23693','92809','32790','23103',
                          '46923','29316','59748','81568','62108',
                          '11213','31003','66602','10577','70899',
                          '18116','92327','51708','23597','34777',
                          '27130','15828','24312','20018','80742',
                          '26122','76023','25778','79884','92637',
                          '42816','10672','35905','12722','52678',
                          '95650','14028','23878','84268','53765',
                          '97185','41544','69036','79264','35044',
                          '85742','41867','39558','68002','25857',
                          '82170','59778','85744','15484','82022',
                          '66914','67709','96287','92255','81448',
                          '51386','93750','51915','33256','65133',
                          '73525','81163','34657','34706','76396',
                          '32934','27701','93877','86675','26498',
                          '44187','35174','86459','24302','38502',
                          '28580','73651','33455','34502','98359',
                          '33617','38029','44586','49808','61396',
                          '67758','75080','47181','60082','21806',
                          '47384','46556','30110','27415','82430',
                          '40837','64655','83812','33517','11746',
                          '33551','53703','19410','79271','46912',
                          '97905','99458','85196','82450','60951',
                          '38773','47926','12032','56590','12126',
                          '31331','78680','30483','25694','89017',
                          '88574','93409','79601','47098','42979',
                          '11149','75606','64560','70524','13329',
                          '86387','33559','86977','16154','55453',
                          '86989','66074','32824','72666','16726',
                          '70259','10733','69623','47837','27456',
                          '70765','96917','93357','82387','41513',
                          '21660','76835','41862','15002','39439',
                          '90547','65784','91401','76332','67257',
                          '37194','52858','21438','65895','98255',
                          '96392','72992','33926','45896','81669',
                          '21713','17821','64423','36480','85902',
                          '68254','29193','72423','15825','61702',
                          '14938','48250','93182','63312','48227',
                          '97834','86075','20905','87490','93931',
                          '25021','51871','50067','71901','26464',
                          '16335','67537','15167','43749','47947',
                          '61347','17050','27470','44583','68964',
                          '14153','52642','75009','18285','30821',
                          '36265','93366','31259','29686','34682',
                          '57978','39302','13123','38704','54242',
                          '77870','21975','20834','19863','72678',
                          '35731','70543','72357','85814','95474',
                          '55951','23592','86061','30169','14340',
                          '16157','27534','90109','36982','53188',
                          '85791','31678','55640','66788','10168',
                          '69931','18077','35699','12767','60038',
                          '65878','32474','78789','47906','96934',
                          '23865','14936','77815','74672','93184',
                          '58938','66872','28277','19975','10769',
                          '21668','33096','50090','32588')
     intersect
      select ca_zip
...
where 
	...
	and d_date between cast('1999-03-21' as date) 
				and dateadd(day,30,cast('1999-03-21' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('1998-06-22' as date) 
 				and dateadd(day,30,cast('1998-06-22' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and i_manufact_id in (174,610,601,169)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Bronx County','Barrow County','Daviess County','Wadena County',
                           'Mesa County','Gogebic County','Pennington County','Gage County')
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Barrow County','Jefferson Davis Parish','Daviess County')
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Friendship'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  46174
   and ib_upper_bound   <=  46174 + 50000
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cream','steel','azure'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 2
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-06-19' as date))
                and dateadd(day,30,cast ('2001-06-19' as date))
 group by
    w_state,i_item_id
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,9,1,8,12,2) and
       d_year = 2000 and
       ca_state in ('LA','TX','OH','VA','ND','IL','MO')
 )
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WV', 'PA', 'MI')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'KY', 'CO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NY', 'NJ', 'VA')
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Springfield','Mount Zion')
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-03-23','2002-10-19','2002-11-17')))
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-26' as date) 
                  and dateadd(day,14,cast('2002-08-26' as date))
