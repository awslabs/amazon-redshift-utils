...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Jackson County','Maverick County','Barrow County','Bronx County')
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 44854 and 44854+28800 
...
where 
	...
	and d_date between cast('2000-04-10' as date) 
				and dateadd(day,30,cast('2000-04-10' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('OK', 'AR', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('UT', 'OH', 'IA')
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('2002-03-19' as date))
                    and dateadd(day,30,cast ('2002-03-19' as date))
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('smoke','chocolate','chiffon'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 6
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-22' as date) 
                  and dateadd(day,30,cast('1999-08-22' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-21' as date) 
                  and dateadd(day,30,cast('2001-08-21' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Fairview','Lakeside')
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 10862 and 10862+1000
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,2,5,7,12,11) and
       d_year = 1998 and
       ca_state in ('TX','KY','OH','MO','IL','MI','GA')
 )
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '75361','86011','75014','94535','85914','70464',
                          '98030','84023','37326','95577','70862',
                          '76722','36935','78483','85158','78592',
                          '77921','72627','48724','47364','97087',
                          '81966','40653','14229','19520','10276',
                          '18435','61822','10872','41096','29150',
                          '28242','96024','38134','92444','76903',
                          '42615','77702','99451','36745','25618',
                          '34950','46881','12635','92966','58308',
                          '85704','61927','53088','89033','78019',
                          '66231','20346','10467','67428','21114',
                          '32237','30177','57504','73514','48992',
                          '91304','40937','71117','30739','38314',
                          '88222','76975','71267','50939','92968',
                          '40504','41179','93046','57699','41651',
                          '35552','62686','84363','12047','58666',
                          '85304','84998','48116','38448','17556',
                          '63518','27955','97603','28163','75982',
                          '85087','68127','65948','14909','35404',
                          '36879','63777','43281','17049','31064',
                          '25792','36138','75679','90708','39383',
                          '47406','68829','64488','11291','85186',
                          '52536','39703','75969','78579','95665',
                          '98681','20199','85975','77020','53594',
                          '66504','21718','76510','14232','29489',
                          '47983','17279','84632','54289','74395',
                          '80240','98876','56747','24511','41575',
                          '48583','96027','24579','37182','35014',
                          '85227','41528','64327','57415','53601',
                          '24293','38566','43224','62382','43337',
                          '98194','75864','91763','80631','84379',
                          '84001','45859','20398','89798','15984',
                          '55203','79803','72725','84738','74050',
                          '83680','26075','59207','83932','82878',
                          '65681','66316','83237','19839','71464',
                          '38213','61379','73101','18912','60995',
                          '82532','94772','28978','12615','30110',
                          '22423','58747','52795','34474','39356',
                          '99117','55861','27134','10717','11096',
                          '94626','60726','71327','52687','27613',
                          '90071','20367','62321','25298','19231',
                          '23532','74968','19324','66373','37873',
                          '99488','38279','71869','92216','80237',
                          '16068','38486','98374','71305','35763',
                          '57804','80931','36201','73770','42351',
                          '51799','22941','57246','37612','87842',
                          '75577','90488','57878','87930','60762',
                          '70921','39682','74818','94573','45548',
                          '23303','36193','94118','73776','86628',
                          '19253','20765','41742','35111','58785',
                          '74537','49768','35444','47014','94110',
                          '90881','49036','54917','11716','10413',
                          '17096','48320','99077','87777','35965',
                          '64860','68943','41817','16387','86935',
                          '25679','71322','39679','56336','97471',
                          '65964','74817','59221','29895','99779',
                          '14092','12458','25112','69149','40360',
                          '92130','82716','13965','41349','93943',
                          '81100','88956','47728','29052','25880',
                          '61017','48558','55468','14387','75390',
                          '58729','92091','95985','70039','24087',
                          '91179','20615','66541','94743','11173',
                          '77705','22383','70432','24720','75275',
                          '12087','18980','85442','89895','42574',
                          '46605','69074','82207','71684','64195',
                          '67202','78379','95372','76122','23609',
                          '86636','36000','84592','38624','74534',
                          '36809','28762','91466','71210','57607',
                          '44505','24689','28638','61826','72129',
                          '35415','74268','83972','47836','42225',
                          '72668','37381','61759','84064','68638',
                          '56130','67558','35593','48044','38958',
                          '72658','32129','74179','32937','89368',
                          '66468','99303','48315','70367','65515',
                          '25020','47074','38016','49865','48939',
                          '11040','54606','40912','67589','84124',
                          '65510','21811','18334','46078','17764',
                          '40648','89529','72862','25506','16282',
                          '71020','11362','89596','46961','37058',
                          '61029','84353','31273','32489')
     intersect
      select ca_zip
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('New Hope','Midway','Fairview','Highland Park','Riverview') 
...
and d_date between '2001-03-24' and 
        dateadd(day,90,cast('2001-03-24' as date))
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Mount Olive'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  25235
   and ib_upper_bound   <=  25235 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Sports','Jewelry','Music') and
          i_class in ('camping','bracelets','classical')
         )
      or (i_category in ('Men','Women','Children') and
          i_class in ('shirts','swimwear','toddlers') 
        ))
group by i_category, i_class, i_brand,
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-06-27','2000-09-17','2000-11-08')))
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1998-06-09' as date))
                and dateadd(day,30,cast ('1998-06-09' as date))
 group by
    w_state,i_item_id
...
and cc_county in ('Levy County','Fairfield County','Huron County','Barrow County',
                  'Williamson County'
)
and exists (select *
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('snow','sienna','slate','royal','floral','light') and
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-10' as date) 
                  and dateadd(day,14,cast('2002-08-10' as date))
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Lonoke County','Stanly County','White County','Greeley County','Le Flore County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
where 
	...
	and d_date between cast('1999-05-14' as date) 
				and dateadd(day,30,cast('1999-05-14' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('1998-02-21' as date) and dateadd(day,60,cast('1998-02-21' as date))
 and i_manufact_id in (931,745,928,775)
...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 721 and 721+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'sandy' or i_color = 'cornflower') and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 7649765
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2312674
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 21856370
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 17768571
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 46038805
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Maverick County','Barrow County','Levy County','Gogebic County',
                           'Kittitas County','Huron County','Jackson County','Pennington County')
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-05-15' as date) and dateadd(day,60,cast('1999-05-15' as date))
 and i_manufact_id in (475,583,955,934)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
