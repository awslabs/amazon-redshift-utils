 ...
 where i_manufact_id between 939 and 939+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'grey' or i_color = 'aquamarine') and
...
and d_date between '1999-01-22' and 
        dateadd(day,90,cast('1999-01-22' as date))
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 23252 and 23252+28800 
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Springdale'
   ...
   and ib_lower_bound   >=  59457
   and ib_upper_bound   <=  59457 + 50000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '11721','52808','46481','61062','98891','59200',
                          '21286','16096','25238','12029','27800',
                          '19458','54524','25921','57374','35520',
                          '39922','88825','39987','17541','44043',
                          '23063','87873','55386','95874','58709',
                          '62023','57557','38960','63942','77582',
                          '65666','47352','96965','88639','80279',
                          '81460','67375','80530','27053','21595',
                          '76486','47870','43866','69806','31515',
                          '60055','30504','52442','37445','11463',
                          '38061','18799','22492','92238','56741',
                          '30574','59522','15692','43763','39283',
                          '57580','74933','40082','14098','61547',
                          '43870','30835','17427','25143','41890',
                          '40828','48673','37259','47625','63515',
                          '53670','33318','12070','42090','68525',
                          '23908','58495','87614','76877','46645',
                          '15768','94024','80262','79433','45413',
                          '15451','17191','26914','65305','19377',
                          '56197','12921','13423','78523','37397',
                          '18904','58634','49573','35981','35161',
                          '54752','55638','65909','35282','22413',
                          '40917','18104','20244','35135','81343',
                          '84925','81074','91173','17770','61874',
                          '85036','19626','20144','17698','19587',
                          '44829','27378','64791','77166','65864',
                          '36687','84284','89854','61677','83642',
                          '90833','30899','24976','67748','21057',
                          '55521','24128','97855','42998','88780',
                          '58769','90247','91882','84489','95051',
                          '33343','69610','89333','66749','35856',
                          '92213','20676','30173','52818','14820',
                          '79388','64401','15046','76756','38743',
                          '27839','42024','34875','77144','55910',
                          '39059','16211','76542','69133','47645',
                          '46521','78267','40394','44656','53538',
                          '91701','26622','25612','56472','78557',
                          '79664','74858','98915','90481','78350',
                          '24089','22245','98808','24829','72908',
                          '95233','97936','16940','56462','42513',
                          '28621','81742','90418','68813','64052',
                          '67038','30682','65453','13681','27055',
                          '50689','66607','64132','63503','33519',
                          '51146','21732','79081','43938','75817',
                          '88510','33821','22414','37980','18111',
                          '96771','28357','48083','61482','35402',
                          '37944','30945','49800','25286','28804',
                          '52475','53656','70214','43026','78836',
                          '89117','71981','82990','43879','75257',
                          '23731','74687','14084','10415','52592',
                          '77823','39360','74300','78455','13772',
                          '28043','20671','13597','47849','30571',
                          '77891','20633','17053','68960','26206',
                          '14479','13668','23804','22655','24233',
                          '88660','21034','21998','46957','48318',
                          '51479','92401','92243','66528','34199',
                          '78730','50931','54438','25117','78270',
                          '54646','27304','35945','84180','99804',
                          '90337','85676','56341','30895','37163',
                          '32673','18778','19013','54544','42107',
                          '95690','51823','86082','97440','12633',
                          '44600','78042','13320','73353','22249',
                          '46156','79832','81237','36260','31063',
                          '13349','26357','66888','79040','43260',
                          '49560','27512','15084','93081','57089',
                          '87062','70689','60771','66169','28051',
                          '27521','66250','57988','69414','52714',
                          '53849','38987','72963','51261','37267',
                          '17898','13946','22645','68435','57167',
                          '33016','80341','99760','61124','65205',
                          '98721','68029','32741','58409','38934',
                          '84856','79623','38845','16474','16870',
                          '77521','42789','84424','54840','84243',
                          '42466','32699','56210','73254','33632',
                          '83847','53965','29794','42784','72833',
                          '14058','18358','21320','18657','65695',
                          '45128','50779','42038','95240','16687',
                          '84735','50525','38039','21010','10127',
                          '13124','93067','96504','30856','12993',
                          '46616','44155','27132','24762')
     intersect
      select ca_zip
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Electronics','Children','Men') and
          i_class in ('memory','infants','shirts')
         )
      or (i_category in ('Sports','Home','Jewelry') and
          i_class in ('sailing','curtains/drapes','jewelry boxes') 
        ))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Friendship','Spring Hill','Mount Vernon','Mount Olive','Fairview') 
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-06-01','1998-09-01','1998-11-09')))
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('2001-02-14' as date))
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-05-06' as date))
                and dateadd(day,30,cast ('2001-05-06' as date))
 group by
    w_state,i_item_id
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 20 and 20+10
          or ss_coupon_amt between 14228 and 14228+1000
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,9,4,8,10,11) and
       d_year = 1999 and
       ca_state in ('TX','NY','AR','MO','WI','AL','GA')
 )
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('2001-03-03' as date) and dateadd(day,60,cast('2001-03-03' as date))
 and i_manufact_id in (887,806,909,728)
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Weld County','Clarendon County','Randolph County','Caldwell County','Union County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and d_date between '2002-02-18' and 
        dateadd(day,90,cast('2002-02-18' as date))
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-04-22' as date) and dateadd(day,60,cast('1998-04-22' as date))
 and i_manufact_id in (772,636,188,93)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('brown','violet','coral'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 5
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Hopewell','Lakeside')
...
and cc_county in ('Barrow County','Luce County','Pennington County','Fairfield County',
                  'Daviess County'
)
and exists (select *
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2002-04-22' as date) 
 				and dateadd(day,30,cast('2002-04-22' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	...
	and d_date between cast('1998-04-09' as date) 
				and dateadd(day,30,cast('1998-04-09' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Daviess County','Richland County','Levy County','Mobile County',
                           'Williamson County','Marshall County','Oglethorpe County','Gage County')
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-19' as date) 
                  and dateadd(day,14,cast('2002-08-19' as date))
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('beige','magenta','ivory','brown','frosted','floral') and
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WY', 'ID', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'SC', 'MT')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MS', 'MO', 'FL')
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Levy County','Gogebic County','Wadena County','Franklin Parish')
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 12702857
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 15506992
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 30830083
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 33887993
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 9825503
            then (select avg(ss_ext_discount_amt)
                  from store_sales
