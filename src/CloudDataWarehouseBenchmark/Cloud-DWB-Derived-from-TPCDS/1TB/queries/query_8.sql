...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('2000-07-14' as date) and dateadd(day,60,cast('2000-07-14' as date))
 and i_manufact_id in (878,994,776,691)
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 55727 and 55727+28800 
...
where 
	...
	and d_date between cast('2002-01-26' as date) 
				and dateadd(day,30,cast('2002-01-26' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-21' as date) 
                  and dateadd(day,30,cast('1999-08-21' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
where 
	...
	and d_date between cast('2001-05-30' as date) 
				and dateadd(day,30,cast('2001-05-30' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and cc_county in ('Pennington County','Huron County','Franklin Parish','Daviess County',
                  'Bronx County'
)
and exists (select *
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-04' as date) 
                  and dateadd(day,14,cast('2002-08-04' as date))
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Daviess County','Ziebach County','Oglethorpe County','San Miguel County')
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Jackson'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  35575
   and ib_upper_bound   <=  35575 + 50000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('violet','rose','black','dark','sky','khaki') and
...
and d_date between '2000-02-25' and 
        dateadd(day,90,cast('2000-02-25' as date))
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Madison County','Lagrange County','Washington County','Johnson County','Huntingdon County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 17877410
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 36489530
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 15089799
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 39845652
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 15904364
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
and d_date between '2002-02-11' and 
        dateadd(day,90,cast('2002-02-11' as date))
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Walker County','Oglethorpe County','Marshall County','Bronx County',
                           'Luce County','Pennington County','Wadena County','Levy County')
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-05' as date) 
                  and dateadd(day,30,cast('1998-08-05' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 144 and 144+10
          or ss_coupon_amt between 7251 and 7251+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 16861 and 16861+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 160 and 160+10
          or ss_coupon_amt between 5629 and 5629+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 94 and 94+10
          or ss_coupon_amt between 12702 and 12702+1000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Shoes','Books','Women') and
          i_class in ('athletic','mystery','maternity')
         )
      or (i_category in ('Electronics','Children','Men') and
          i_class in ('dvd/vcr players','infants','accessories') 
        ))
group by i_category, i_class, i_brand,
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('plum','navy','sky'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 4
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Lakewood','Fairfield','Bethel','Midway','Pleasant Valley') 
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '48871','20471','42624','50715','28065','34670',
                          '94486','94915','18633','69919','82857',
                          '91066','24096','20467','12332','37157',
                          '78088','92694','58768','43188','79744',
                          '70511','37705','11931','48067','25428',
                          '86346','30544','78396','27762','24877',
                          '13037','32626','31228','36819','83792',
                          '55973','53855','86500','24902','75287',
                          '53562','43669','84784','87985','40288',
                          '74271','48889','79861','75089','32229',
                          '55593','23914','16821','90897','22971',
                          '63121','89257','46570','15439','51918',
                          '67757','54846','20558','71196','97233',
                          '21330','81352','80706','80130','23273',
                          '19482','97041','17429','72888','67555',
                          '39005','14808','94550','98323','26627',
                          '36748','94564','11367','16931','11998',
                          '49057','80984','89878','18450','35766',
                          '29677','67593','73211','86367','18631',
                          '90563','89648','60402','42718','30271',
                          '34309','10763','18039','35700','58474',
                          '63345','15040','57671','56109','42048',
                          '76053','50361','34669','83624','79240',
                          '22197','76563','56532','82844','74024',
                          '29801','48652','38091','41616','38186',
                          '68241','17275','84247','21943','81946',
                          '90947','65009','56906','45819','76877',
                          '97141','98529','63297','15243','68881',
                          '93491','66609','69815','17905','30612',
                          '96471','80812','13239','49520','64135',
                          '80808','60267','82806','41361','25526',
                          '95582','16030','88719','89000','26120',
                          '15736','85559','15217','41541','51391',
                          '83912','45645','38120','53712','69613',
                          '45283','32152','52785','20462','76530',
                          '71272','84366','96442','73024','50429',
                          '36771','69328','49855','32852','64506',
                          '59221','54416','75488','65902','98906',
                          '83097','79554','16150','38191','19184',
                          '30060','96599','47309','61826','11983',
                          '39842','16562','95297','40567','95661',
                          '40148','47172','79343','49105','72825',
                          '73565','66126','17406','20491','55585',
                          '40207','56203','29430','80011','60643',
                          '16683','69650','72928','47092','12411',
                          '79198','24612','64930','16998','65754',
                          '15129','81234','85024','72261','98926',
                          '56967','92505','72785','95401','61531',
                          '31667','59532','57921','53123','38844',
                          '13174','58851','96873','55083','82505',
                          '85623','14805','23459','30411','36250',
                          '54014','17443','39983','50901','24182',
                          '30604','57138','90106','31718','60285',
                          '38621','11379','14864','19887','70660',
                          '48018','34490','32829','58671','23012',
                          '14563','96587','12056','26706','73414',
                          '62750','96465','96345','23623','72304',
                          '92552','55292','12734','80677','16257',
                          '80729','33360','21419','24466','14189',
                          '89722','18809','90832','48448','39760',
                          '92476','24732','38531','36760','30252',
                          '84962','57759','70300','81193','18083',
                          '62752','55745','29392','99046','72990',
                          '50792','44482','29924','23440','52661',
                          '91873','10609','23979','85437','91237',
                          '36336','61535','50058','45846','39326',
                          '52881','19549','47155','51440','57926',
                          '82425','84874','95371','82915','96742',
                          '68414','28843','79682','87577','58274',
                          '43265','42063','75413','59550','73366',
                          '25939','26564','47689','26110','80964',
                          '90500','74070','82988','12840','33158',
                          '39566','86840','66753','64578','35850',
                          '37874','85567','73415','12523','80037',
                          '70219','73843','17158','70367','89695',
                          '46451','64523','47601','61855','12419',
                          '36234','83989','15229','68895','14033',
                          '53122','71677','16286','47290','29029',
                          '75199','35837','64743','66170','26168',
                          '55075','87870','52308','62621')
     intersect
      select ca_zip
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-01-19' as date) and dateadd(day,60,cast('2001-01-19' as date))
 and i_manufact_id in (430,479,518,741)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('1998-01-17' as date) 
 				and dateadd(day,30,cast('1998-01-17' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-04-25','2002-08-12','2002-11-15')))
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Oakland','Mount Vernon')
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,6,5,10,7,8) and
       d_year = 2000 and
       ca_state in ('GA','WI','KS','VA','CO','TX','AR')
 )
