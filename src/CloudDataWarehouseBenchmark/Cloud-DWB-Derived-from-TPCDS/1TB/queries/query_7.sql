...
and d_date between '1999-02-04' and 
        dateadd(day,90,cast('1999-02-04' as date))
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('tomato','light','brown','linen','peru','coral') and
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Huron County','Franklin Parish','Marshall County','Walker County',
                           'Ziebach County','Barrow County','Mesa County','Bronx County')
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MO', 'MI', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ME', 'VA', 'KS')
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 134 and 134+10
          or ss_coupon_amt between 13577 and 13577+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 119 and 119+10
          or ss_coupon_amt between 14611 and 14611+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 97 and 97+10
          or ss_coupon_amt between 3089 and 3089+1000
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Stringtown'
   ...
   and ib_lower_bound   >=  65038
   and ib_upper_bound   <=  65038 + 50000
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-27' as date) 
                  and dateadd(day,30,cast('1998-08-27' as date)) 
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('2000-03-24' as date))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Mount Vernon','Antioch','Highland','Liberty','Hopewell') 
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Day County','Richland Parish','Halifax County','Yell County','Macon County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('2002-05-09' as date) and dateadd(day,60,cast('2002-05-09' as date))
 and i_manufact_id in (846,695,891,729)
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 33702262
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 24945373
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 34905847
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 28344702
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 46493740
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1999-02-19' as date))
                and dateadd(day,30,cast ('1999-02-19' as date))
 group by
    w_state,i_item_id
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-05-12' as date) and dateadd(day,60,cast('1999-05-12' as date))
 and i_manufact_id in (533,414,545,741)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-12' as date) 
                  and dateadd(day,14,cast('2001-08-12' as date))
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Mesa County','Gage County','Gogebic County','Mobile County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Children','Sports','Men') and
          i_class in ('infants','archery','pants')
         )
      or (i_category in ('Music','Home','Shoes') and
          i_class in ('rock','blinds/shades','athletic') 
        ))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,7,6,10,2,9) and
       d_year = 2001 and
       ca_state in ('TX','CO','GA','TN','SC','AR','KS')
 )
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('coral','lime','almond'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 2
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-04-22','2000-10-08','2000-11-17')))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '98054','93480','66655','19448','65152','70957',
                          '63596','70498','12820','56244','91474',
                          '53043','68043','67394','93722','76099',
                          '52876','58477','39104','85460','14500',
                          '37149','84105','65381','58980','38185',
                          '16904','56494','91549','84695','51870',
                          '11821','90346','55551','92958','96850',
                          '58785','19723','85664','95782','95140',
                          '55839','71976','49752','57887','37518',
                          '67728','28318','12578','47393','37558',
                          '46461','83952','24741','51217','33974',
                          '31730','34451','14542','66054','27742',
                          '50320','16427','84604','78603','89350',
                          '50849','82230','39669','32414','80686',
                          '43746','90808','95237','82222','82226',
                          '28711','25564','79740','73948','31674',
                          '52882','93420','41135','79896','98543',
                          '75280','64102','98542','56235','95942',
                          '90905','70195','81271','21384','55747',
                          '45665','57842','96887','23794','15299',
                          '42379','44992','17373','29973','32527',
                          '28212','95876','71058','33339','48424',
                          '44874','88726','60327','21307','65516',
                          '56612','42801','88280','30798','99021',
                          '40296','67893','40972','48882','32459',
                          '80451','13869','35444','56153','37169',
                          '33182','15551','92885','37538','36421',
                          '47865','76325','35261','95207','43365',
                          '12378','33050','47036','77342','73166',
                          '92991','59698','31994','21060','54343',
                          '33837','87783','15652','56584','79148',
                          '33205','22794','63136','53850','52227',
                          '81526','54553','11025','65552','81208',
                          '49453','11701','92144','39796','18215',
                          '17408','90470','31575','95701','33975',
                          '81520','79188','58664','52813','15222',
                          '34776','72108','60725','12823','29476',
                          '75040','48525','30488','93231','97960',
                          '38505','36905','73513','64560','95588',
                          '38395','98608','44769','97352','26911',
                          '62837','89826','14778','38360','49977',
                          '43859','35789','27305','86579','93414',
                          '73869','17375','93702','38404','40571',
                          '52932','85264','24914','33373','52166',
                          '14643','63974','60533','69002','72425',
                          '75737','41620','14032','39210','96288',
                          '68046','72235','45886','36386','96675',
                          '87912','24564','71468','25668','41090',
                          '54511','99501','60786','96419','46695',
                          '85716','38559','75487','10436','70447',
                          '10809','58878','55061','80028','76845',
                          '83334','46846','73670','51536','16229',
                          '24829','62084','88692','38788','58678',
                          '60293','36978','32795','85595','24050',
                          '83275','67317','87515','90780','75975',
                          '90894','77141','22483','21568','79418',
                          '64872','70180','90238','32805','32368',
                          '23169','77954','49928','49837','96461',
                          '50683','22030','42592','95208','21598',
                          '23257','50103','47389','47139','67428',
                          '27339','35292','30964','71479','29632',
                          '72884','87449','33498','81679','24033',
                          '67592','47803','11660','70464','74472',
                          '20242','15871','23787','22325','49131',
                          '37972','67957','83264','18580','45510',
                          '74254','78791','30989','88576','44483',
                          '39419','17662','22476','26942','40411',
                          '83568','69293','41272','17194','35627',
                          '38101','42872','74603','90541','55111',
                          '67717','50283','64932','18369','37501',
                          '61601','26968','32034','45840','17663',
                          '49517','23637','14530','10092','81174',
                          '83047','76440','16157','66702','28966',
                          '48069','86534','64363','69678','28090',
                          '49742','14030','95828','88153','81694',
                          '49769','23804','77549','31174','80969',
                          '63089','98469','88514','88942','21074',
                          '36389','92813','36852','55062','78800',
                          '51016','68249','10208','91459','48195',
                          '70684','17615','47385','57543')
     intersect
      select ca_zip
...
where 
	...
	and d_date between cast('2002-06-14' as date) 
				and dateadd(day,30,cast('2002-06-14' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Franklin','Highland Park')
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 50190 and 50190+28800 
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-11' as date) 
                  and dateadd(day,30,cast('1999-08-11' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
and cc_county in ('Jefferson Davis Parish','Bronx County','Dauphin County','Richland County',
                  'Barrow County'
)
and exists (select *
