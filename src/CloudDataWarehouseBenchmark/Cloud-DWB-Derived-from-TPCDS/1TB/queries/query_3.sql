...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Music','Children','Books') and
          i_class in ('pop','school-uniforms','mystery')
         )
      or (i_category in ('Jewelry','Home','Shoes') and
          i_class in ('earings','bathroom','athletic') 
        ))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,1,2,12,7,4) and
       d_year = 1999 and
       ca_state in ('IA','TX','AL','AK','ND','VA','KY')
 )
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('mint','light','midnight'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 2
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Wildwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  1343
   and ib_upper_bound   <=  1343 + 50000
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Keokuk County','Hartford County','Chickasaw County','Loudon County','Winnebago County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '92817','79001','47088','58647','55896','15263',
                          '36198','80242','79483','70416','22272',
                          '84430','36233','36355','90031','43538',
                          '10655','33025','34972','44056','14064',
                          '43891','45168','84049','10513','24319',
                          '72385','92885','22319','93443','32827',
                          '29233','23550','12642','94979','56879',
                          '88171','50377','27802','98537','46038',
                          '11066','83392','78728','98322','17476',
                          '67135','55903','83098','46193','44313',
                          '51463','66769','48790','52059','58922',
                          '59698','75248','52430','18634','98092',
                          '70218','74575','68600','19961','10347',
                          '72460','64634','73483','35793','12583',
                          '27879','83929','83784','10605','49565',
                          '27307','37267','45948','95178','52867',
                          '46094','32787','99645','83492','85179',
                          '93687','76814','88498','44515','80551',
                          '92893','47757','99202','44121','35780',
                          '24146','46023','86203','18968','11012',
                          '77635','63926','20937','82060','42650',
                          '96874','54868','31746','85927','58677',
                          '27401','82725','62363','77760','37804',
                          '96999','34541','46125','66798','10898',
                          '27985','48968','75510','62905','78897',
                          '70671','50417','44948','33863','55126',
                          '46278','32721','30955','42516','77129',
                          '19863','17920','89128','95055','50885',
                          '49402','12174','79397','26021','13001',
                          '52078','78171','21453','77037','87693',
                          '42728','98071','97230','39739','67466',
                          '31331','66137','17087','67999','53588',
                          '81959','48936','28477','78202','40022',
                          '27708','36740','92789','40116','55098',
                          '10051','28257','85843','11430','62797',
                          '79622','60995','61249','40518','20904',
                          '98197','90730','76424','90746','18727',
                          '26123','67933','95618','75984','62412',
                          '37786','38265','54702','84134','60224',
                          '80908','42388','73076','69728','33817',
                          '63123','71094','81052','61403','41849',
                          '41809','42997','87551','36610','24180',
                          '70084','82664','10010','81108','40129',
                          '73339','68490','36662','33557','35967',
                          '87949','86648','12250','38580','63384',
                          '34679','61128','31337','23112','61494',
                          '45403','28928','25347','37618','39332',
                          '52433','97316','66254','57101','32220',
                          '14862','93394','85988','69232','11143',
                          '70824','98915','75124','39388','77925',
                          '72394','25296','14903','16932','87422',
                          '16994','72812','70551','19427','54781',
                          '51857','83655','12886','96500','82946',
                          '18263','73234','42083','73176','27178',
                          '68904','17220','94797','95462','69024',
                          '66417','99194','27854','29830','55211',
                          '81447','64992','96823','40969','13493',
                          '94194','85707','64412','40864','75269',
                          '22608','38795','35790','91787','28864',
                          '27447','44760','99581','80367','59989',
                          '70855','42574','27977','83209','57205',
                          '75798','44281','62090','96842','38316',
                          '69776','79354','47917','47178','87802',
                          '68350','23369','31104','48236','91321',
                          '52665','91110','82642','22879','72936',
                          '38706','60408','42985','76520','17709',
                          '59299','29903','83366','20812','31019',
                          '39917','44439','17686','40068','91644',
                          '61676','48579','29604','84809','33664',
                          '33043','38582','45613','36990','85101',
                          '19460','90640','89624','99088','89096',
                          '16534','38741','74247','46428','64115',
                          '49856','50888','78574','60350','15642',
                          '27840','45813','51790','61078','82761',
                          '12662','59388','70148','87666','39285',
                          '50804','75493','99603','56072','42905',
                          '99164','83718','54075','79795','20435',
                          '24510','11352','75450','70260','34418',
                          '51656','74711','26807','51715','81068',
                          '41097','82894','36275','42810')
     intersect
      select ca_zip
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('2000-06-16' as date) and dateadd(day,60,cast('2000-06-16' as date))
 and i_manufact_id in (700,707,816,679)
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 7680 and 7680+28800 
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('2000-03-14' as date))
                    and dateadd(day,30,cast ('2000-03-14' as date))
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and i_manufact_id in (929,95,341,793)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Shady Grove','Pleasant Grove','Oakdale','New Hope','Walnut Grove') 
 ...
 where i_manufact_id between 981 and 981+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'sandy' or i_color = 'hot') and
        (i_units = 'Oz' or i_units = 'Case') and
        (i_size = 'small' or i_size = 'medium')
        ) or
        (i_category = 'Men' and
        (i_color = 'orange' or i_color = 'blanched') and
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1998-05-07' as date))
...
and cc_county in ('Mobile County','Huron County','Ziebach County','Franklin Parish',
                  'Kittitas County'
)
and exists (select *
...
and d_date between '2001-03-15' and 
        dateadd(day,90,cast('2001-03-15' as date))
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Dauphin County','Mesa County','Walker County','Luce County',
                           'Huron County','Wadena County','Mobile County','Daviess County')
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-05-17','1999-10-01','1999-11-13')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 137 and 137+10
          or ss_coupon_amt between 1106 and 1106+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 95 and 95+10
          or ss_coupon_amt between 8521 and 8521+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 14193 and 14193+1000
...
where 
	...
	and d_date between cast('1998-02-10' as date) 
				and dateadd(day,30,cast('1998-02-10' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','burnished','sky','smoke','dodger','cornflower') and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 47236180
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 5289053
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 3676053
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 4662835
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 20199102
            then (select avg(ss_ext_tax)
                  from store_sales
...
and d_date between '2001-02-02' and 
        dateadd(day,90,cast('2001-02-02' as date))
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('San Miguel County','Wadena County','Maverick County','Luce County')
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2000-03-19' as date) 
 				and dateadd(day,30,cast('2000-03-19' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
