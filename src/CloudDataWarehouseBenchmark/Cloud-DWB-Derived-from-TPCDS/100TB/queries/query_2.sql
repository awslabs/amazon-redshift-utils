...
where 
	...
	and d_date between cast('2001-03-14' as date) 
				and dateadd(day,30,cast('2001-03-14' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-29' as date) 
                  and dateadd(day,14,cast('2001-08-29' as date))
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2002-01-30' as date) and dateadd(day,60,cast('2002-01-30' as date))
...
where 
	...
	and d_date between cast('1998-05-04' as date) 
				and dateadd(day,30,cast('1998-05-04' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('1998-03-22' as date) 
 				and dateadd(day,30,cast('1998-03-22' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '2002-03-12' and 
        dateadd(day,90,cast('2002-03-12' as date))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       d_year = 2000 and
       ca_state in ('MS','GA','CO','NE','MO','NC','MD')
 )
...
and d_date between '1998-03-16' and 
        dateadd(day,90,cast('1998-03-16' as date))
