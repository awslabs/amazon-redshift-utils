-- start template query57.tpl query 1 in stream 8
...
-- end template query57.tpl query 1 in stream 8
-- start template query29.tpl query 2 in stream 8
...
-- end template query29.tpl query 2 in stream 8
-- start template query24.tpl query 3 in stream 8
...
-- end template query24.tpl query 3 in stream 8
-- start template query76.tpl query 4 in stream 8
...
-- end template query76.tpl query 4 in stream 8
-- start template query37.tpl query 5 in stream 8
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('2002-04-30' as date) and dateadd(day,60,cast('2002-04-30' as date))
 and i_manufact_id in (780,702,758,827)
...
-- end template query37.tpl query 5 in stream 8
-- start template query66.tpl query 6 in stream 8
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 12974 and 12974+28800 
...
-- end template query66.tpl query 6 in stream 8
-- start template query60.tpl query 7 in stream 8
...
-- end template query60.tpl query 7 in stream 8
-- start template query98.tpl query 8 in stream 8
...
where 
	...
	and d_date between cast('1999-03-22' as date) 
				and dateadd(day,30,cast('1999-03-22' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- end template query98.tpl query 8 in stream 8
-- start template query80a.tpl query 9 in stream 8
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-22' as date) 
                  and dateadd(day,30,cast('2000-08-22' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
-- end template query80a.tpl query 9 in stream 8
-- start template query12.tpl query 10 in stream 8
...
where 
	...
	and d_date between cast('1998-04-02' as date) 
				and dateadd(day,30,cast('1998-04-02' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- end template query12.tpl query 10 in stream 8
-- start template query59.tpl query 11 in stream 8
...
-- end template query59.tpl query 11 in stream 8
-- start template query70a.tpl query 12 in stream 8
...
-- end template query70a.tpl query 12 in stream 8
-- start template query91.tpl query 13 in stream 8
...
-- end template query91.tpl query 13 in stream 8
-- start template query69.tpl query 14 in stream 8
...
-- end template query69.tpl query 14 in stream 8
-- start template query40.tpl query 15 in stream 8
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-05-19' as date))
                and dateadd(day,30,cast ('2001-05-19' as date))
 group by
    w_state,i_item_id
 order by w_state,i_item_id
limit 100;

-- end template query40.tpl query 15 in stream 8
-- start template query2.tpl query 16 in stream 8
...
-- end template query2.tpl query 16 in stream 8
-- start template query16.tpl query 17 in stream 8
...
and cc_county in ('Kittitas County','Perry County','Franklin Parish','Sierra County',
                  'Bronx County'
)
and exists (select *
...
-- end template query16.tpl query 17 in stream 8
-- start template query44.tpl query 18 in stream 8
...
-- end template query44.tpl query 18 in stream 8
-- start template query5a.tpl query 19 in stream 8
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-25' as date) 
                  and dateadd(day,14,cast('2000-08-25' as date))
...
-- end template query5a.tpl query 19 in stream 8
-- start template query73.tpl query 20 in stream 8
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Ziebach County','Lake County','Huron County','Baltimore County')
    group by ss_ticket_number,ss_customer_sk) dj,customer
    where ss_customer_sk = c_customer_sk
      and cnt between 1 and 5
    order by cnt desc, c_last_name asc;

-- end template query73.tpl query 20 in stream 8
-- start template query14a.tpl query 21 in stream 8
...
-- end template query14a.tpl query 21 in stream 8
-- start template query71.tpl query 22 in stream 8
...
-- end template query71.tpl query 22 in stream 8
-- start template query3.tpl query 23 in stream 8
...
-- end template query3.tpl query 23 in stream 8
-- start template query49.tpl query 24 in stream 8
...
-- end template query49.tpl query 24 in stream 8
-- start template query84.tpl query 25 in stream 8
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Stringtown'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  56947
   and ib_upper_bound   <=  56947 + 50000
...
-- end template query84.tpl query 25 in stream 8
-- start template query64.tpl query 26 in stream 8
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('brown','thistle','metallic','light','cream','violet') and
...
-- end template query64.tpl query 26 in stream 8
-- start template query7.tpl query 27 in stream 8
...
-- end template query7.tpl query 27 in stream 8
-- start template query36a.tpl query 28 in stream 8
...
-- end template query36a.tpl query 28 in stream 8
-- start template query61.tpl query 29 in stream 8
select /* TPC-DS query61.tpl 0.97 */  promotions,total,cast(promotions as decimal(16,4))/cast(total as decimal(16,4))*100
from
...
-- end template query61.tpl query 29 in stream 8
-- start template query41.tpl query 30 in stream 8
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 727 and 727+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'spring' or i_color = 'moccasin') and 
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'powder' or i_color = 'light') and
...
-- end template query41.tpl query 30 in stream 8
-- start template query35a.tpl query 31 in stream 8
...
-- end template query35a.tpl query 31 in stream 8
-- start template query50.tpl query 32 in stream 8
...
-- end template query50.tpl query 32 in stream 8
-- start template query65.tpl query 33 in stream 8
...
-- end template query65.tpl query 33 in stream 8
-- start template query51.tpl query 34 in stream 8
...
-- end template query51.tpl query 34 in stream 8
-- start template query78.tpl query 35 in stream 8
...
-- end template query78.tpl query 35 in stream 8
-- start template query21.tpl query 36 in stream 8
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('2000-03-23' as date))
                    and dateadd(day,30,cast ('2000-03-23' as date))
...
-- end template query21.tpl query 36 in stream 8
-- start template query67a.tpl query 37 in stream 8
...
-- end template query67a.tpl query 37 in stream 8
-- start template query22a.tpl query 38 in stream 8
...
-- end template query22a.tpl query 38 in stream 8
-- start template query81.tpl query 39 in stream 8
...
-- end template query81.tpl query 39 in stream 8
-- start template query93.tpl query 40 in stream 8
...
-- end template query93.tpl query 40 in stream 8
-- start template query25.tpl query 41 in stream 8
...
-- end template query25.tpl query 41 in stream 8
-- start template query26.tpl query 42 in stream 8
...
-- end template query26.tpl query 42 in stream 8
-- start template query90.tpl query 43 in stream 8
...
-- end template query90.tpl query 43 in stream 8
-- start template query74.tpl query 44 in stream 8
...
-- end template query74.tpl query 44 in stream 8
-- start template query92.tpl query 45 in stream 8
...
and d_date between '1999-03-16' and 
        dateadd(day,90,cast('1999-03-16' as date))
...
-- end template query92.tpl query 45 in stream 8
-- start template query75.tpl query 46 in stream 8
...
-- end template query75.tpl query 46 in stream 8
-- start template query10.tpl query 47 in stream 8
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Elk County','Chatham County','Middlesex County','Waldo County','Fulton County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
-- end template query10.tpl query 47 in stream 8
-- start template query58.tpl query 48 in stream 8
...
-- end template query58.tpl query 48 in stream 8
-- start template query6.tpl query 49 in stream 8
...
-- end template query6.tpl query 49 in stream 8
-- start template query47.tpl query 50 in stream 8
...
-- end template query47.tpl query 50 in stream 8
-- start template query30.tpl query 51 in stream 8
...
-- end template query30.tpl query 51 in stream 8
-- start template query94.tpl query 52 in stream 8
...
-- end template query94.tpl query 52 in stream 8
-- start template query97.tpl query 53 in stream 8
...
-- end template query97.tpl query 53 in stream 8
-- start template query55.tpl query 54 in stream 8
...
-- end template query55.tpl query 54 in stream 8
-- start template query72.tpl query 55 in stream 8
...
-- end template query72.tpl query 55 in stream 8
-- start template query95.tpl query 56 in stream 8
...
-- end template query95.tpl query 56 in stream 8
-- start template query86a.tpl query 57 in stream 8
...
-- end template query86a.tpl query 57 in stream 8
-- start template query39.tpl query 58 in stream 8
...
-- end template query39.tpl query 58 in stream 8
-- start template query17.tpl query 59 in stream 8
...
-- end template query17.tpl query 59 in stream 8
-- start template query42.tpl query 60 in stream 8
...
-- end template query42.tpl query 60 in stream 8
-- start template query85.tpl query 61 in stream 8
...
-- end template query85.tpl query 61 in stream 8
-- start template query9.tpl query 62 in stream 8
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 2143141710
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2081061254
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1249493601
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 1415848901
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 2244990348
            then (select avg(ss_ext_tax)
                  from store_sales
...
-- end template query9.tpl query 62 in stream 8
-- start template query32.tpl query 63 in stream 8
...
-- end template query32.tpl query 63 in stream 8
-- start template query34.tpl query 64 in stream 8
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Houston County','Wilkinson County','Montgomery County','Pacific County',
                           'Monroe County','Jackson County','Quay County','Marshall County')
    group by ss_ticket_number,ss_customer_sk) dn,customer
    where ss_customer_sk = c_customer_sk
      and cnt between 15 and 20
    order by c_last_name,c_first_name,c_salutation,c_preferred_cust_flag desc, ss_ticket_number;

-- end template query34.tpl query 64 in stream 8
-- start template query79.tpl query 65 in stream 8
...
-- end template query79.tpl query 65 in stream 8
-- start template query54.tpl query 66 in stream 8
...
-- end template query54.tpl query 66 in stream 8
-- start template query77a.tpl query 67 in stream 8
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-27' as date) 
                  and dateadd(day,30,cast('2002-08-27' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- end template query77a.tpl query 67 in stream 8
-- start template query45.tpl query 68 in stream 8
...
-- end template query45.tpl query 68 in stream 8
-- start template query28.tpl query 69 in stream 8
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 37 and 37+10
          or ss_coupon_amt between 4899 and 4899+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 25 and 25+10
          or ss_coupon_amt between 593 and 593+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 62 and 62+10
          or ss_coupon_amt between 17850 and 17850+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 109 and 109+10
          or ss_coupon_amt between 1979 and 1979+1000
          or ss_wholesale_cost between 0 and 0+20)) B6
limit 100;

-- end template query28.tpl query 69 in stream 8
-- start template query11.tpl query 70 in stream 8
...
-- end template query11.tpl query 70 in stream 8
-- start template query89.tpl query 71 in stream 8
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Books','Electronics','Home') and
          i_class in ('reference','automotive','bedding')
         )
      or (i_category in ('Music','Women','Men') and
          i_class in ('country','maternity','pants') 
        ))
group by i_category, i_class, i_brand,
...
-- end template query89.tpl query 71 in stream 8
-- start template query56.tpl query 72 in stream 8
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('floral','sienna','azure'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 7
...
-- end template query56.tpl query 72 in stream 8
-- start template query46.tpl query 73 in stream 8
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Buffalo','Smyrna','Simpson','Three Forks','Diamond') 
...
-- end template query46.tpl query 73 in stream 8
-- start template query19.tpl query 74 in stream 8
...
-- end template query19.tpl query 74 in stream 8
-- start template query62.tpl query 75 in stream 8
...
-- end template query62.tpl query 75 in stream 8
-- start template query8.tpl query 76 in stream 8
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '10384','19472','40133','20556','13959','81439',
                          '53057','63016','75034','58025','86060',
                          '82290','85524','81781','67029','36420',
                          '49586','18363','37453','13000','89918',
                          '42357','16191','76566','45498','98462',
                          '59728','49009','39399','46761','62246',
                          '46593','97207','92026','74927','59146',
                          '80922','78544','65909','74579','55886',
                          '95991','87264','64747','93083','81186',
                          '97731','94962','84261','89903','33767',
                          '58929','68325','60211','87874','37486',
                          '37803','34925','14226','74378','79092',
                          '61267','25115','18302','52500','60913',
                          '46831','45961','76317','41750','76220',
                          '65475','28576','53414','96052','54661',
                          '23820','68934','63646','19590','49232',
                          '90390','52750','36739','21489','56291',
                          '16272','96163','68398','93420','83175',
                          '98895','68345','79967','24361','75758',
                          '80399','19470','17768','47108','67537',
                          '66281','99515','64908','25288','74194',
                          '69252','40930','92658','14886','99938',
                          '20416','56958','66859','31812','88363',
                          '38561','56999','62661','30843','84081',
                          '53017','24407','49944','87368','36431',
                          '31068','91844','80114','75662','21191',
                          '12350','23736','66399','17891','47036',
                          '72601','56807','85187','20512','82620',
                          '77951','92167','79078','73353','15303',
                          '66760','11770','12949','12886','96699',
                          '80462','52710','38371','80191','95958',
                          '58522','10415','27981','99865','84806',
                          '47035','24225','70102','99500','76577',
                          '80730','73877','82318','39505','75683',
                          '82454','44908','60712','14424','80705',
                          '98939','31976','12779','71541','86693',
                          '35042','66686','50680','32559','88726',
                          '65578','59179','25573','85163','55029',
                          '56926','10129','48193','34731','54453',
                          '15718','80751','25962','54407','53382',
                          '77024','79419','96266','45808','15709',
                          '24832','82659','66216','50027','70959',
                          '16163','77438','94247','79201','80941',
                          '53369','36729','26487','22466','87868',
                          '69362','37995','30540','47408','47786',
                          '57363','25703','68608','63140','94145',
                          '98992','54306','55103','62315','52869',
                          '69987','25524','75468','68682','87377',
                          '52752','48392','18254','61614','29301',
                          '29236','76423','97294','71074','55655',
                          '58129','64606','12196','74331','76971',
                          '68454','84365','42637','68946','69862',
                          '30281','28852','30757','66536','96320',
                          '42355','41590','60125','13742','10762',
                          '85194','50292','21620','84429','87169',
                          '87952','10615','22791','99054','47857',
                          '44187','88048','92785','52730','39979',
                          '37527','72483','83780','74379','98622',
                          '31561','30625','52528','15006','21846',
                          '54537','20273','64611','34188','88477',
                          '86364','62732','16079','57048','80359',
                          '58099','38110','47980','60405','70836',
                          '47909','34836','57234','80721','23091',
                          '68427','84390','59234','62694','33097',
                          '24899','23588','59293','20897','82307',
                          '97672','68192','72957','26191','30288',
                          '59608','18259','64679','23746','38351',
                          '66579','33160','43037','80578','29862',
                          '15241','18296','23389','70827','85351',
                          '89071','74685','64318','16821','57912',
                          '82972','35228','37841','96662','89332',
                          '61853','30868','72368','14287','43871',
                          '29141','41899','48997','58297','99092',
                          '25576','13033','24055','18870','44688',
                          '50044','88589','22689','67643','48726',
                          '26557','60419','42002','88074','74567',
                          '69120','97756','68979','74131','84506',
                          '94576','49089','26224','83310','83193',
                          '62796','34904','57719','50330','59341',
                          '57965','21743','23068','38980')
     intersect
      select ca_zip
...
-- end template query8.tpl query 76 in stream 8
-- start template query96.tpl query 77 in stream 8
...
-- end template query96.tpl query 77 in stream 8
-- start template query1.tpl query 78 in stream 8
...
-- end template query1.tpl query 78 in stream 8
-- start template query23.tpl query 79 in stream 8
...
-- end template query23.tpl query 79 in stream 8
-- start template query88.tpl query 80 in stream 8
...
-- end template query88.tpl query 80 in stream 8
-- start template query82.tpl query 81 in stream 8
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-07-03' as date) and dateadd(day,60,cast('2002-07-03' as date))
 and i_manufact_id in (765,226,314,870)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
-- end template query82.tpl query 81 in stream 8
-- start template query87.tpl query 82 in stream 8
...
-- end template query87.tpl query 82 in stream 8
-- start template query43.tpl query 83 in stream 8
...
-- end template query43.tpl query 83 in stream 8
-- start template query53.tpl query 84 in stream 8
...
-- end template query53.tpl query 84 in stream 8
-- start template query20.tpl query 85 in stream 8
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2002-05-24' as date) 
 				and dateadd(day,30,cast('2002-05-24' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
-- end template query20.tpl query 85 in stream 8
-- start template query52.tpl query 86 in stream 8
...
-- end template query52.tpl query 86 in stream 8
-- start template query83.tpl query 87 in stream 8
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-03-29','2001-09-13','2001-11-17')))
...
-- end template query83.tpl query 87 in stream 8
-- start template query38.tpl query 88 in stream 8
...
-- end template query38.tpl query 88 in stream 8
-- start template query68.tpl query 89 in stream 8
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 3 or
             household_demographics.hd_vehicle_count= 4)
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Johnson','Lakeside')
...
-- end template query68.tpl query 89 in stream 8
-- start template query4.tpl query 90 in stream 8
...
-- end template query4.tpl query 90 in stream 8
-- start template query13.tpl query 91 in stream 8
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_country = 'United States'
  and ca_state in ('MT', 'SC', 'PA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WI', 'VA', 'MN')
  and ss_net_profit between 50 and 250  
     ))
;

-- end template query13.tpl query 91 in stream 8
-- start template query48.tpl query 92 in stream 8
...
-- end template query48.tpl query 92 in stream 8
-- start template query99.tpl query 93 in stream 8
...
-- end template query99.tpl query 93 in stream 8
-- start template query27a.tpl query 94 in stream 8
...
-- end template query27a.tpl query 94 in stream 8
-- start template query18a.tpl query 95 in stream 8
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,5,4,3,11,12) and
       d_year = 2002 and
       ca_state in ('MO','SD','MS','OR','NC','OH','IL')
 )
...
-- end template query18a.tpl query 95 in stream 8
-- start template query15.tpl query 96 in stream 8
...
-- end template query15.tpl query 96 in stream 8
-- start template query33.tpl query 97 in stream 8
...
-- end template query33.tpl query 97 in stream 8
-- start template query31.tpl query 98 in stream 8
...
-- end template query31.tpl query 98 in stream 8
-- start template query63.tpl query 99 in stream 8
...
-- end template query63.tpl query 99 in stream 8
