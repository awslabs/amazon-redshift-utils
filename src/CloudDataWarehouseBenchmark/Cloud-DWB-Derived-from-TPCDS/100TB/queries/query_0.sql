...
and d_date between '1999-03-21' and 
        dateadd(day,90,cast('1999-03-21' as date))
...
where 
	...
	and d_date between cast('2002-03-10' as date) 
				and dateadd(day,30,cast('2002-03-10' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2002-01-25' as date) 
 				and dateadd(day,30,cast('2002-01-25' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-03-27' as date) and dateadd(day,60,cast('1998-03-27' as date))
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-19' as date) 
                  and dateadd(day,30,cast('2000-08-19' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2002-02-10' as date))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       d_year = 1998 and
       ca_state in ('OR','FL','WV','TN','NE','IL','MN')
 )
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-06' as date) 
                  and dateadd(day,14,cast('2002-08-06' as date))
