...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Tehama County','Quay County','Lake County','Nuckolls County')
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 55161 and 55161+28800 
...
where 
	...
	and d_date between cast('1998-01-13' as date) 
				and dateadd(day,30,cast('1998-01-13' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('pale','forest','rosy'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 4
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-27' as date) 
                  and dateadd(day,30,cast('2000-08-27' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
and d_date between '1999-01-19' and 
        dateadd(day,90,cast('1999-01-19' as date))
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Valley View','Rockdale')
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 75 and 75+10 
             or ss_coupon_amt between 6663 and 6663+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 6 and 6+10
          or ss_coupon_amt between 15537 and 15537+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 190 and 190+10
          or ss_coupon_amt between 15915 and 15915+1000
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,10,7,2,4,9) and
       d_year = 1999 and
       ca_state in ('AL','IA','MS','CO','FL','KS','TX')
 )
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '48160','46510','31716','14741','53921','89218',
                          '81977','19391','57119','70056','16854',
                          '79271','39895','98936','40889','93961',
                          '11468','99764','92079','65614','10826',
                          '13890','23898','72853','36788','77021',
                          '34589','22253','92488','23221','26995',
                          '56283','70886','42631','43791','51387',
                          '32326','26172','83133','52141','64986',
                          '29752','18164','33290','13784','46698',
                          '83684','17388','86633','71915','69850',
                          '14128','15794','89770','70968','99230',
                          '67569','45564','76173','76815','51552',
                          '75887','74328','31908','28756','97937',
                          '72995','29277','59080','51675','25248',
                          '45056','91605','53872','67893','43359',
                          '28319','42761','39542','78228','34780',
                          '76674','59992','36405','61753','35205',
                          '66913','63625','37513','80427','85163',
                          '93473','14513','69136','28007','68230',
                          '95865','16988','16137','68273','75512',
                          '34371','13317','58298','37338','68787',
                          '60358','60400','94637','20970','81786',
                          '85925','97605','88176','35718','58333',
                          '80493','77747','96457','27113','86783',
                          '90294','11850','55435','80507','28482',
                          '52491','59378','76166','78807','64356',
                          '61046','78494','37890','73309','24138',
                          '63488','90373','33470','46767','35828',
                          '14445','42968','95434','82361','42793',
                          '80946','31173','76744','87738','33665',
                          '96128','75503','16549','58724','99340',
                          '91375','31020','21033','60497','50379',
                          '60738','77188','46183','92062','79151',
                          '20104','88255','57140','68681','59387',
                          '58885','39177','20508','25766','50730',
                          '14230','93041','44328','79288','79095',
                          '62001','34597','29558','45486','53712',
                          '93770','77798','54907','77754','10058',
                          '21109','96264','42377','24485','84558',
                          '92181','15376','42400','49723','66596',
                          '94990','21072','77989','82765','60040',
                          '32117','13253','30394','12437','33410',
                          '53553','91273','58151','35593','96045',
                          '27523','58448','72695','89409','87335',
                          '25823','35490','87743','76658','17350',
                          '25757','89911','58135','23897','21947',
                          '62654','15939','29290','74895','61383',
                          '19084','26828','23178','26837','28276',
                          '34214','69969','77296','28421','10343',
                          '85123','88292','52517','57613','75337',
                          '70813','67189','27270','30872','28639',
                          '19795','13795','93156','22309','52639',
                          '10539','37814','31347','84338','45298',
                          '57781','54732','60369','74683','25037',
                          '20776','87548','68996','22618','99912',
                          '74132','55833','11597','68513','20758',
                          '10305','68821','90518','43456','51894',
                          '15412','88203','87293','35414','57784',
                          '14189','85140','97134','40283','95359',
                          '28594','51852','64404','55447','36544',
                          '62671','79828','46770','71163','41630',
                          '36465','64636','69813','29975','17215',
                          '92325','10051','57460','30852','27646',
                          '90648','11907','96556','66382','88305',
                          '66567','57304','25051','63991','45018',
                          '17305','72599','61143','23495','67570',
                          '84811','42527','52869','79860','57144',
                          '42857','38243','91476','90127','61098',
                          '91427','15534','99204','17672','26789',
                          '98690','73360','76090','29151','26405',
                          '15642','92654','80919','22754','75827',
                          '96902','98029','93767','48980','12257',
                          '65671','43601','31394','22338','58494',
                          '85647','10712','45271','99021','34617',
                          '95935','64295','43881','97742','72808',
                          '50524','16429','89309','88170','98122',
                          '52373','17471','95161','35157','44264',
                          '55258','84995','66758','69405','48435',
                          '92729','56104','64042','39807','35331',
                          '43714','29840','58568','61599')
     intersect
      select ca_zip
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Ashland','Henderson','Lakewood','Sunrise','Cloverdale') 
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Wildwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  39522
   and ib_upper_bound   <=  39522 + 50000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Women','Books','Home') and
          i_class in ('swimwear','travel','kids')
         )
      or (i_category in ('Shoes','Jewelry','Electronics') and
          i_class in ('womens','custom','dvd/vcr players') 
        ))
group by i_category, i_class, i_brand,
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-05-31','2000-10-11','2000-11-11')))
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-04-28' as date))
                and dateadd(day,30,cast ('2001-04-28' as date))
 group by
    w_state,i_item_id
...
and cc_county in ('Fairfield County','Marshall County','Raleigh County','Barrow County',
                  'Mesa County'
)
and exists (select *
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('salmon','snow','cornflower','seashell','papaya','magenta') and
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2000-05-12' as date) 
 				and dateadd(day,30,cast('2000-05-12' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Rusk County','Floyd County','Olmsted County','Towns County','Colorado County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
where 
	...
	and d_date between cast('2001-06-23' as date) 
				and dateadd(day,30,cast('2001-06-23' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and i_manufact_id in (765,670,986,719)
...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 904 and 904+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'almond' or i_color = 'brown') and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 76283367
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 915064718
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1178232047
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 940715072
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1385311618
            then (select avg(ss_ext_tax)
                  from store_sales
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Quay County','Levy County','Delta County','Baltimore County',
                           'Daviess County','Raleigh County','Tolland County','San Miguel County')
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-07-12' as date) and dateadd(day,60,cast('2001-07-12' as date))
 and i_manufact_id in (277,281,703,66)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
