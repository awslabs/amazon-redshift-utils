...
set query_group to 'TPC-DS query34.tpl stream.6.1';
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Gage County','Van Buren County','Jefferson County',
                           'Grant County','West Feliciana Parish','Anderson County','Nuckolls County')
...
set query_group to 'TPC-DS query88.tpl stream.6.2';
...
set query_group to 'TPC-DS query44.tpl stream.6.3';
...
set query_group to 'TPC-DS query94.tpl stream.6.4';
...
set query_group to 'TPC-DS query50.tpl stream.6.5';
...
set query_group to 'TPC-DS query5a.tpl stream.6.6';
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-08' as date) 
                  and dateadd(day,14,cast('2000-08-08' as date))
...
-- end query 6 in stream 6 using template query5a.tpl
set query_group to 'TPC-DS query53.tpl stream.6.7';
...
set query_group to 'TPC-DS query7.tpl stream.6.8';
...
set query_group to 'TPC-DS query58.tpl stream.6.9';
...
set query_group to 'TPC-DS query20.tpl stream.6.10';
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2000-03-07' as date) 
 				and dateadd(day,30,cast('2000-03-07' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
set query_group to 'TPC-DS query75.tpl stream.6.11';
...
set query_group to 'TPC-DS query73.tpl stream.6.12';
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Huron County','Mobile County','Hubbard County','Ford County')
...
set query_group to 'TPC-DS query91.tpl stream.6.13';
...
set query_group to 'TPC-DS query36a.tpl stream.6.14';
...
-- end query 14 in stream 6 using template query36a.tpl
set query_group to 'TPC-DS query11.tpl stream.6.15';
...
set query_group to 'TPC-DS query80a.tpl stream.6.16';
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-14' as date) 
                  and dateadd(day,30,cast('2000-08-14' as date)) 
       and ss_store_sk = s_store_sk
...
-- end query 16 in stream 6 using template query80a.tpl
set query_group to 'TPC-DS query9.tpl stream.6.17';
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 908876767
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 58568196
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 73020230
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 515039925
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 758038236
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
set query_group to 'TPC-DS query93.tpl stream.6.18';
...
set query_group to 'TPC-DS query32.tpl stream.6.19';
...
set query_group to 'TPC-DS query89.tpl stream.6.20';
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Music','Jewelry','Electronics') and
          i_class in ('pop','estate','portable')
         )
      or (i_category in ('Home','Children','Books') and
          i_class in ('bathroom','infants','mystery') 
        ))
...
set query_group to 'TPC-DS query28.tpl stream.6.21';
...
set query_group to 'TPC-DS query18a.tpl stream.6.23';
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,4,12,5,8,1) and
       d_year = 2001 and
       ca_state in ('TN','TX','AZ','VA','NM','WI','MO')
 )
...
-- end query 23 in stream 6 using template query18a.tpl
set query_group to 'TPC-DS query74.tpl stream.6.24';
...
set query_group to 'TPC-DS query6.tpl stream.6.25';
...
set query_group to 'TPC-DS query65.tpl stream.6.26';
...
set query_group to 'TPC-DS query84.tpl stream.6.27';
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Midway'
   ...
   and ib_lower_bound   >=  69540
   and ib_upper_bound   <=  69540 + 50000
...
set query_group to 'TPC-DS query14a.tpl stream.6.28';
...
-- end query 28 in stream 6 using template query14a.tpl
set query_group to 'TPC-DS query38.tpl stream.6.29';
...
set query_group to 'TPC-DS query24.tpl stream.6.30';
...
set query_group to 'TPC-DS query42.tpl stream.6.31';
...
set query_group to 'TPC-DS query29.tpl stream.6.32';
...
set query_group to 'TPC-DS query72.tpl stream.6.33';
...
set query_group to 'TPC-DS query23.tpl stream.6.34';
...
set query_group to 'TPC-DS query26.tpl stream.6.35';
...
set query_group to 'TPC-DS query69.tpl stream.6.36';
...
set query_group to 'TPC-DS query47.tpl stream.6.37';
...
set query_group to 'TPC-DS query82.tpl stream.6.38';
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2002-06-09' as date) and dateadd(day,60,cast('2002-06-09' as date))
 and i_manufact_id in (459,737,695,530)
...
set query_group to 'TPC-DS query31.tpl stream.6.39';
...
set query_group to 'TPC-DS query59.tpl stream.6.40';
...
set query_group to 'TPC-DS query49.tpl stream.6.41';
...
set query_group to 'TPC-DS query33.tpl stream.6.42';
...
set query_group to 'TPC-DS query86a.tpl stream.6.43';
...
-- end query 43 in stream 6 using template query86a.tpl
set query_group to 'TPC-DS query99.tpl stream.6.44';
...
set query_group to 'TPC-DS query4.tpl stream.6.45';
...
set query_group to 'TPC-DS query45.tpl stream.6.46';
...
set query_group to 'TPC-DS query85.tpl stream.6.47';
...
set query_group to 'TPC-DS query8.tpl stream.6.48';
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '96729','87140','22032','96181','79687','27366',
                          '39879','52424','42159','83732','40284',
                          '12094','95000','95937','45530','75403',
                          '75143','13127','43682','72486','49451',
                          '56539','45174','89496','20763','13261',
                          '98512','93987','76387','19617','34170',
                          '40296','96976','42015','13301','38970',
                          '97226','82726','78834','67730','28674',
                          '43203','81002','18716','53769','49082',
                          '14234','11211','18955','22370','95011',
                          '12978','27833','11503','63720','71221',
                          '28463','20985','36687','23683','31132',
                          '79334','63666','33470','44072','29405',
                          '44289','65888','26548','11371','63156',
                          '92471','56271','69782','81629','72678',
                          '82136','46793','29577','27528','70945',
                          '85729','56116','97757','89687','54167',
                          '43407','34094','98415','49075','25179',
                          '72066','92642','72532','51809','55573',
                          '51549','19463','17020','52018','94327',
                          '36975','56939','73738','99243','48380',
                          '30354','36154','45856','14030','41358',
                          '73719','29822','63236','29112','16400',
                          '35262','99123','55422','35824','42745',
                          '86425','53354','43665','47406','57017',
                          '62063','38513','65624','63752','73175',
                          '59259','39578','15808','84706','84381',
                          '94319','90360','36210','31406','50773',
                          '43733','30165','61182','23199','54301',
                          '97272','21894','29672','29346','84765',
                          '16373','69271','51255','22015','60680',
                          '63929','43071','24134','16131','14869',
                          '53785','42030','75765','12207','96093',
                          '16699','41369','36574','44550','29255',
                          '11531','18658','33391','33438','39201',
                          '23579','46848','19221','35795','68951',
                          '44712','12135','18087','28190','96234',
                          '83119','62415','39977','20137','18008',
                          '16314','95119','90467','46951','56667',
                          '84458','49892','72004','71281','17053',
                          '16305','60455','23652','23296','25188',
                          '93454','79914','81722','23696','73342',
                          '98637','95206','48438','41450','24205',
                          '32360','56074','77463','58252','26940',
                          '66447','98968','96566','46838','22798',
                          '97772','92334','95017','78840','61464',
                          '83168','27364','62357','67967','30089',
                          '24505','62039','27921','74626','27681',
                          '79547','33281','74543','10074','25144',
                          '28301','58774','67426','83293','83407',
                          '70066','11519','27462','55555','22472',
                          '14332','59986','33228','55830','25392',
                          '76354','12735','22031','56487','36458',
                          '81946','35599','13690','22753','46822',
                          '30562','37397','13839','97509','23896',
                          '76515','63316','33491','32794','46567',
                          '34944','55626','11553','24615','23850',
                          '17522','37790','29424','23417','92722',
                          '94608','65020','78525','95404','62982',
                          '24848','20708','22500','69810','42685',
                          '34969','59995','62469','45667','69956',
                          '61115','33165','93858','49070','85429',
                          '58801','22351','52894','97724','57681',
                          '34804','93657','22734','41882','63702',
                          '19282','72050','40580','67422','84001',
                          '38568','25416','15512','26165','73804',
                          '88959','82212','52651','37987','11577',
                          '74238','88228','51988','74877','36380',
                          '15888','60530','93291','84902','59820',
                          '52463','56678','88290','70313','30150',
                          '74642','40764','53979','42711','24963',
                          '33572','46040','18434','13738','15142',
                          '45679','94433','98442','69081','30226',
                          '21146','54076','73239','20513','84947',
                          '63196','42523','37254','23093','83464',
                          '27609','37794','83094','41271','42528',
                          '75835','97424','86879','27260','47621',
                          '42314','22036','72478','44618','89700',
                          '61443','11069','10951','81040','77025',
                          '70148','99462','36848','29885')
     intersect
      select ca_zip
...
set query_group to 'TPC-DS query19.tpl stream.6.49';
...
set query_group to 'TPC-DS query61.tpl stream.6.50';
...
set query_group to 'TPC-DS query3.tpl stream.6.51';
...
set query_group to 'TPC-DS query41.tpl stream.6.52';
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 942 and 942+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'metallic' or i_color = 'azure') and 
        ...
        (i_category = 'Men' and
        (i_color = 'honeydew' or i_color = 'coral') and
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'midnight' or i_color = 'aquamarine') and 
...
set query_group to 'TPC-DS query54.tpl stream.6.53';
...
set query_group to 'TPC-DS query67a.tpl stream.6.54';
...
-- end query 54 in stream 6 using template query67a.tpl
set query_group to 'TPC-DS query77a.tpl stream.6.55';
...
-- end query 55 in stream 6 using template query77a.tpl
set query_group to 'TPC-DS query15.tpl stream.6.56';
...
set query_group to 'TPC-DS query51.tpl stream.6.57';
...
set query_group to 'TPC-DS query98.tpl stream.6.58';
...
set query_group to 'TPC-DS query62.tpl stream.6.59';
...
set query_group to 'TPC-DS query97.tpl stream.6.60';
...
set query_group to 'TPC-DS query22a.tpl stream.6.61';
...
-- end query 61 in stream 6 using template query22a.tpl
set query_group to 'TPC-DS query48.tpl stream.6.62';
...
set query_group to 'TPC-DS query2.tpl stream.6.63';
...
set query_group to 'TPC-DS query79.tpl stream.6.64';
...
set query_group to 'TPC-DS query56.tpl stream.6.65';
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('ghost','cornsilk','plum'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 3
...
set query_group to 'TPC-DS query37.tpl stream.6.66';
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-04-21' as date) and dateadd(day,60,cast('2001-04-21' as date))
 and i_manufact_id in (1000,733,827,841)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
set query_group to 'TPC-DS query10.tpl stream.6.67';
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Itawamba County','Williamson County','Hardin County','Bristol County','Hall County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
set query_group to 'TPC-DS query90.tpl stream.6.68';
...
set query_group to 'TPC-DS query21.tpl stream.6.69';
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('1999-03-01' as date))
                    and dateadd(day,30,cast ('1999-03-01' as date))
...
set query_group to 'TPC-DS query46.tpl stream.6.70';
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Cedar Grove','Sunset','Windsor','Keystone','Jefferson') 
...
set query_group to 'TPC-DS query83.tpl stream.6.71';
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-03-12','2000-10-20','2000-11-16')))
...
set query_group to 'TPC-DS query96.tpl stream.6.72';
...
set query_group to 'TPC-DS query68.tpl stream.6.73';
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Five Forks','Westwood')
...
set query_group to 'TPC-DS query63.tpl stream.6.74';
...
set query_group to 'TPC-DS query92.tpl stream.6.75';
...
and d_date between '1998-02-14' and 
        dateadd(day,90,cast('1998-02-14' as date))
...
set query_group to 'TPC-DS query27a.tpl stream.6.76';
...
-- end query 76 in stream 6 using template query27a.tpl
set query_group to 'TPC-DS query12.tpl stream.6.77';
...
where 
	...
	and d_date between cast('1999-05-21' as date) 
				and dateadd(day,30,cast('1999-05-21' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
set query_group to 'TPC-DS query64.tpl stream.6.78';
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','ivory','almond','blue','dark','antique') and
...
set query_group to 'TPC-DS query95.tpl stream.6.79';
...
set query_group to 'TPC-DS query39.tpl stream.6.80';
...
set query_group to 'TPC-DS query35.tpl stream.6.81';
...
set query_group to 'TPC-DS query78.tpl stream.6.82';
...
set query_group to 'TPC-DS query57.tpl stream.6.83';
...
set query_group to 'TPC-DS query66.tpl stream.6.84';
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 37215 and 37215+28800 
...
set query_group to 'TPC-DS query71.tpl stream.6.85';
...
set query_group to 'TPC-DS query30.tpl stream.6.86';
...
set query_group to 'TPC-DS query1.tpl stream.6.87';
...
set query_group to 'TPC-DS query81.tpl stream.6.88';
...
set query_group to 'TPC-DS query43.tpl stream.6.89';
...
set query_group to 'TPC-DS query52.tpl stream.6.90';
...
set query_group to 'TPC-DS query13.tpl stream.6.91';
...
set query_group to 'TPC-DS query76.tpl stream.6.92';
...
set query_group to 'TPC-DS query17.tpl stream.6.93';
...
set query_group to 'TPC-DS query25.tpl stream.6.94';
...
set query_group to 'TPC-DS query40.tpl stream.6.95';
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2000-04-06' as date))
                and dateadd(day,30,cast ('2000-04-06' as date))
 group by
    w_state,i_item_id
...
set query_group to 'TPC-DS query70a.tpl stream.6.96';
...
-- end query 96 in stream 6 using template query70a.tpl
set query_group to 'TPC-DS query55.tpl stream.6.97';
...
set query_group to 'TPC-DS query60.tpl stream.6.98';
...
set query_group to 'TPC-DS query16.tpl stream.6.99';
...
and cc_county in ('Jefferson Davis Parish','Maverick County','Gage County','Huron County',
                  'Oglethorpe County'
)
and exists (select *
