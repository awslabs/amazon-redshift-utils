...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('antique','light','deep'))
...
where 
	...
	and d_date between cast('2001-01-30' as date) 
				and dateadd(day,30,cast('2001-01-30' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-04-23','1999-08-20','1999-11-12')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 40 and 40+10 
             or ss_coupon_amt between 16698 and 16698+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 28 and 28+10
          or ss_coupon_amt between 10912 and 10912+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 3 and 3+10
          or ss_coupon_amt between 619 and 619+1000
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Hope','Dixie')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '35509','88624','14891','40528','43750','41568',
                          '89057','55340','95110','33584','22754',
                          '18687','20445','40572','80812','99405',
                          '65801','91914','24930','17615','91489',
                          '56553','73760','82626','68885','18100',
                          '58419','38785','18193','36554','33094',
                          '84745','10989','86471','21678','67232',
                          '13286','75196','91024','44541','83242',
                          '17581','41230','22358','33747','22064',
                          '73215','73710','14108','62892','32107',
                          '20830','11310','44140','84929','70626',
                          '26446','89984','65523','79746','80677',
                          '59473','81856','53729','19166','30851',
                          '26537','93695','68431','78789','52219',
                          '97941','16214','10907','53609','96629',
                          '57991','97032','12514','72271','78878',
                          '51388','99155','90892','71563','52790',
                          '44392','94099','69103','24261','41387',
                          '46371','43781','55047','40760','27473',
                          '83220','20644','52068','50657','42440',
                          '68646','48462','28951','50834','99259',
                          '41107','60626','34291','85619','11645',
                          '17451','55160','39224','70451','13427',
                          '31341','58683','81630','14759','57345',
                          '91643','43135','88496','74051','27900',
                          '50965','66332','69921','51796','16912',
                          '56188','89465','76532','69838','50988',
                          '59439','76202','19172','32606','72979',
                          '75969','77746','89381','65641','76566',
                          '92038','21338','87022','89111','56795',
                          '86311','52056','39846','77229','58213',
                          '89298','94865','39679','84956','99376',
                          '24593','16370','27609','87985','93507',
                          '23833','45615','40257','91772','51349',
                          '54307','37810','97056','44090','33546',
                          '47616','18092','89937','65980','51983',
                          '44202','76610','84448','74754','75256',
                          '71637','66976','34701','58581','37010',
                          '62805','40480','95068','74199','78453',
                          '11194','64134','44907','83843','33508',
                          '15354','98100','80792','50758','91076',
                          '62603','41640','30814','45347','27972',
                          '69179','15357','41839','91519','87411',
                          '39541','57014','39841','35407','21123',
                          '36015','51279','47234','21490','21553',
                          '74486','68697','51344','30124','49775',
                          '78690','32977','24790','58515','31323',
                          '68312','13424','77866','61292','65425',
                          '52095','10838','95117','62484','50880',
                          '41940','56647','28106','57303','41354',
                          '78361','42794','80151','69665','36979',
                          '84254','49602','25328','94863','12604',
                          '80831','87225','25909','95877','91743',
                          '27354','21962','68758','54268','88251',
                          '64464','68125','13603','71348','52852',
                          '58744','69294','71078','65189','49727',
                          '35178','58193','87909','55815','19700',
                          '11732','46034','47493','91343','54700',
                          '42163','28151','32714','62015','33046',
                          '16052','50139','52738','43481','54233',
                          '63640','71159','27724','36971','18830',
                          '21782','84119','86428','73777','51934',
                          '52682','30926','22937','58397','75983',
                          '93660','55042','57009','49218','24634',
                          '70884','47046','75440','63671','71355',
                          '51567','46262','46426','38901','25853',
                          '29508','13967','16146','12175','54260',
                          '66178','32587','21728','75267','35644',
                          '31712','28462','54149','98995','94773',
                          '26298','31565','32715','63736','60015',
                          '42616','27582','66446','17737','63382',
                          '77794','60633','25763','55478','40847',
                          '37649','13402','88825','33881','62088',
                          '60288','21761','12560','37002','41500',
                          '92570','81196','74413','35637','67620',
                          '39638','27828','65930','79091','36491',
                          '33771','78500','38222','30834','87001',
                          '29054','11302','28164','27450','65454',
                          '50385','63769','74190','68235','21173',
                          '75687','88002','84742','14417')
     intersect
      select ca_zip
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-25' as date) 
                  and dateadd(day,30,cast('2002-08-25' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('1998-05-09' as date))
                    and dateadd(day,30,cast ('1998-05-09' as date))
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Lawrence County','Union County','Madison County','Barton County','Humboldt County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2001-01-17' as date) and dateadd(day,60,cast('2001-01-17' as date))
 and i_manufact_id in (600,655,913,505)
...
and cc_county in ('Luce County','Richland County','Franklin Parish','Daviess County',
                  'Fairfield County'
)
and exists (select *
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2000-04-10' as date))
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Dutchess County','Forsyth County','Stafford County','Appanoose County')
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Florence'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  36654
   and ib_upper_bound   <=  36654 + 50000
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-03-13' as date) and dateadd(day,60,cast('1998-03-13' as date))
 and i_manufact_id in (996,760,827,721)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	...
	and d_date between cast('2001-06-10' as date) 
				and dateadd(day,30,cast('2001-06-10' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('hot','frosted','cornsilk','almond','turquoise','chartreuse') and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1367954516
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 846121970
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 610625567
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 1013435592
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 67777199
            then (select avg(ss_ext_tax)
                  from store_sales
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,3,4,2,5,6) and
       d_year = 1999 and
       ca_state in ('IA','IN','WI','GA','KY','TN','TX')
 )
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Perry County','San Miguel County','Levy County','Rush County',
                           'Henry County','Tolland County','Carter County','Quay County')
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NE', 'NV', 'MA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OR', 'ND', 'TX')
...
and d_date between '2001-01-30' and 
        dateadd(day,90,cast('2001-01-30' as date))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Douglas','Lowell','Oak Hill','Washington','Eureka') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Shoes','Books','Music') and
          i_class in ('athletic','parenting','country')
         )
      or (i_category in ('Women','Electronics','Jewelry') and
          i_class in ('maternity','personal','womens watch') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 17905 and 17905+28800 
