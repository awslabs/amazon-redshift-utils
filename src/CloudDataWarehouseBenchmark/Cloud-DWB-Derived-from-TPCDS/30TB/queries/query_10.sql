...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('1998-03-08' as date))
                    and dateadd(day,30,cast ('1998-03-08' as date))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,10,11,8,4,3) and
       d_year = 1998 and
       ca_state in ('IL','GA','IA','KS','OK','SD','MO')
 )
...
and d_date between '2002-03-28' and 
        dateadd(day,90,cast('2002-03-28' as date))
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 16999 and 16999+28800 
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2000-06-12' as date) 
 				and dateadd(day,30,cast('2000-06-12' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	...
	and d_date between cast('1999-05-22' as date) 
				and dateadd(day,30,cast('1999-05-22' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2000-01-21' as date) and dateadd(day,60,cast('2000-01-21' as date))
 and i_manufact_id in (538,369,881,395)
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-04-05' as date) and dateadd(day,60,cast('2000-04-05' as date))
 and i_manufact_id in (709,756,866,726)
 and inv_quantity_on_hand between 100 and 500
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navy','wheat','coral','magenta','steel','pale') and
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-18' as date) 
                  and dateadd(day,30,cast('1998-08-18' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-09' as date) 
                  and dateadd(day,30,cast('2001-08-09' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oakland'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  11869
   and ib_upper_bound   <=  11869 + 50000
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Wythe County','Island County','Bennington County','Telfair County','Carter County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and cc_county in ('Fairfield County','Kittitas County','Sierra County','Maverick County',
                  'San Miguel County'
)
and exists (select *
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-20' as date) 
                  and dateadd(day,14,cast('2000-08-20' as date))
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('McHenry County','Camden County','Warren County','Pipestone County',
                           'Harding County','Anderson County','Brown County','Walker County')
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-02-20' as date))
                and dateadd(day,30,cast ('2001-02-20' as date))
 group by
    w_state,i_item_id
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Sierra County','Green Lake County','Richland County','Forsyth County')
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('pink','moccasin','brown'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 7
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-04-16','1999-10-02','1999-11-16')))
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Franklin','Milford')
...
where 
	...
	and d_date between cast('1999-04-21' as date) 
				and dateadd(day,30,cast('1999-04-21' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Jewelry','Books','Women') and
          i_class in ('consignment','parenting','maternity')
         )
      or (i_category in ('Shoes','Home','Music') and
          i_class in ('athletic','rugs','classical') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Hamilton','Magnolia','Richmond','Sunnyside','Milton') 
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MO', 'WI', 'MI')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WY', 'MS', 'ID')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'TX', 'LA')
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1314783047
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 1100255701
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1413807265
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 865602814
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 876742971
            then (select avg(ss_ext_discount_amt)
                  from store_sales
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '64796','68374','41951','91225','54579','55296',
                          '14428','28397','87936','23920','94110',
                          '16366','44973','38947','98902','88106',
                          '24338','98771','61630','63764','35757',
                          '54370','47057','79225','53206','50368',
                          '22154','42010','58588','56384','57678',
                          '96985','65311','50264','83774','67007',
                          '77085','77169','78006','87624','91039',
                          '40544','21710','18570','78482','73759',
                          '21594','98950','82744','26626','47178',
                          '33241','25013','88493','45210','88630',
                          '13689','79575','30440','25442','83232',
                          '62279','87764','87787','26346','45046',
                          '17277','76597','92518','63633','61369',
                          '54478','28565','51873','66587','10552',
                          '21809','38620','95007','83066','73305',
                          '49170','60516','30516','65608','85164',
                          '52137','19721','30608','12544','57906',
                          '93466','41323','97155','20641','41087',
                          '11247','88518','74439','49483','23292',
                          '43462','60283','29454','12290','35379',
                          '27986','24480','22558','41899','16678',
                          '56550','15027','80489','19096','92128',
                          '57879','29781','15335','69044','27428',
                          '99075','90735','70644','92591','63201',
                          '61625','78591','44850','77250','27203',
                          '20737','48183','59338','68752','20548',
                          '66356','42964','66917','75962','76955',
                          '38425','36647','22547','96957','69269',
                          '25538','48904','50374','55287','88650',
                          '81099','39802','28960','18728','65395',
                          '54401','12823','12127','25523','15562',
                          '24010','19965','28268','39355','55125',
                          '73473','36355','71327','64407','94875',
                          '54516','79237','96378','72106','34364',
                          '82892','42856','90910','44515','72433',
                          '92879','31691','14721','13282','26390',
                          '31433','13708','92353','68751','33448',
                          '64832','63604','90531','93284','82199',
                          '60631','96239','16028','19391','67723',
                          '86914','48291','50191','19229','77291',
                          '31805','46144','23438','64163','56753',
                          '25631','14627','98844','92582','59186',
                          '37641','33170','54916','36477','40146',
                          '30240','61346','12514','55984','18992',
                          '38133','67338','24141','16703','11017',
                          '63883','57524','83453','38476','30913',
                          '73774','31164','78424','69338','41416',
                          '61497','50648','79724','37497','58702',
                          '71312','28943','18464','35158','59395',
                          '60589','17042','10974','73039','71504',
                          '59904','40164','98041','74469','75660',
                          '25240','12357','32121','61936','66870',
                          '50686','47243','67602','39240','40914',
                          '81062','57393','49977','12177','19912',
                          '96740','44919','59656','33778','21877',
                          '42401','64750','33562','88901','28762',
                          '90930','84850','88920','71442','18688',
                          '17070','73729','34547','14216','91496',
                          '82247','14113','45854','68721','78759',
                          '75714','13686','26454','29104','18278',
                          '44488','77305','28043','35959','35951',
                          '68746','28295','50607','31963','98086',
                          '97311','44279','51912','31882','93195',
                          '50916','82054','67802','52201','48074',
                          '44092','97586','30805','47736','85268',
                          '68136','56569','94514','67837','23493',
                          '72561','61571','37061','96116','95260',
                          '42286','36733','26291','42474','96504',
                          '16841','81620','60912','34446','22853',
                          '34304','80736','22731','24546','86033',
                          '52149','87344','51884','47167','36358',
                          '82792','24244','80344','81666','19935',
                          '38159','98389','63178','61408','93937',
                          '39172','94718','43081','56021','53520',
                          '78261','16040','77537','33903','92054',
                          '20273','56779','25942','32857','20930',
                          '56215','45839','55773','86942','94656',
                          '10611','89473','34586','69295','20760',
                          '55257','37812','65573','82364')
     intersect
      select ca_zip
