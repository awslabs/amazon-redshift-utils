...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('1999-04-06' as date) and dateadd(day,60,cast('1999-04-06' as date))
 and i_manufact_id in (717,694,828,830)
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 54367 and 54367+28800 
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-29' as date) 
                  and dateadd(day,30,cast('2002-08-29' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
where 
	...
	and d_date between cast('2002-04-26' as date) 
				and dateadd(day,30,cast('2002-04-26' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2000-03-26' as date))
                and dateadd(day,30,cast ('2000-03-26' as date))
 group by
    w_state,i_item_id
...
and cc_county in ('Wadena County','Jackson County','Barrow County','Jefferson Davis Parish',
                  'Maverick County'
)
and exists (select *
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-18' as date) 
                  and dateadd(day,14,cast('2000-08-18' as date))
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Wilkinson County','Porter County','Val Verde County','Levy County')
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('pink','bisque','blanched','steel','plum','goldenrod') and
 ...
 where i_manufact_id between 984 and 984+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'salmon' or i_color = 'khaki') and
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('1998-06-24' as date))
                    and dateadd(day,30,cast ('1998-06-24' as date))
...
and d_date between '2002-01-07' and 
        dateadd(day,90,cast('2002-01-07' as date))
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Broward County','Roseau County','Sussex County','Walker County','Northampton County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 378382331
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 512942160
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1235307501
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 897669097
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 466207173
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
and d_date between '2000-02-10' and 
        dateadd(day,90,cast('2000-02-10' as date))
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Jefferson County','Miller County','Coal County','Warren County',
                           'Franklin Parish','Richland County','Piute County','Stillwater County')
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-20' as date) 
                  and dateadd(day,30,cast('1998-08-20' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 144 and 144+10 
             or ss_coupon_amt between 5845 and 5845+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 11 and 11+10
          or ss_coupon_amt between 13985 and 13985+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 110 and 110+10
          or ss_coupon_amt between 14625 and 14625+1000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Jewelry','Electronics') and
          i_class in ('football','birdal','musical')
         )
      or (i_category in ('Music','Home','Women') and
          i_class in ('pop','rugs','maternity') 
        ))
group by i_category, i_class, i_brand,
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('turquoise','beige','violet'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 5
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Marion','Woodlawn','Johnson','Cross Roads','Rockville') 
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '68853','85062','82519','38394','38708','98506',
                          '62182','95730','11854','96941','44504',
                          '70281','89504','40168','69207','31019',
                          '15334','92179','15021','64512','79470',
                          '14962','30774','58834','17685','28052',
                          '71398','14745','45449','39470','36298',
                          '94257','81077','47447','19534','85710',
                          '38646','57967','34990','58452','10258',
                          '42280','75872','97050','33723','46451',
                          '48872','27073','51885','56413','93499',
                          '14509','69491','24222','34549','98232',
                          '88580','32575','29756','25384','69941',
                          '98265','99029','43934','33510','60690',
                          '63955','13684','59735','39059','87329',
                          '66685','87277','27304','59610','35349',
                          '74894','75083','13908','57639','75185',
                          '31667','91314','61894','87366','60685',
                          '93081','69541','34583','70304','65383',
                          '63158','66714','66683','11961','42474',
                          '27257','38881','92625','75030','66733',
                          '67085','49434','44186','91609','40077',
                          '72442','88935','69474','79649','50212',
                          '22115','27856','90264','36781','12422',
                          '22515','59526','55064','18643','17273',
                          '64766','37625','45070','28183','38389',
                          '52593','34120','27358','67355','89784',
                          '36925','82074','15115','77737','89019',
                          '65902','50165','93577','55890','90004',
                          '28393','88241','45423','71990','57177',
                          '88130','54401','70595','65153','33662',
                          '31715','83365','88385','13552','18224',
                          '13568','76110','17528','87167','40125',
                          '30004','41608','42046','56368','49556',
                          '79771','22757','90518','69226','53903',
                          '34992','19063','16041','23034','92538',
                          '56361','84179','30990','15904','97659',
                          '74778','11998','57676','32129','47634',
                          '20817','61193','69290','23736','26792',
                          '84288','36443','26767','64620','31824',
                          '54667','61742','63331','31262','95879',
                          '12100','37784','15344','54389','77856',
                          '42871','26095','21424','19499','44842',
                          '86026','20183','24049','84178','12107',
                          '52594','63490','48552','44201','75019',
                          '57528','28631','41657','52151','16601',
                          '86476','61405','15501','49032','64319',
                          '81618','29863','50685','44020','24973',
                          '19411','22299','74184','13490','45088',
                          '75677','30674','44763','20902','37225',
                          '72065','67911','74084','15916','15316',
                          '74741','25836','98059','19090','35608',
                          '67785','52161','75714','60277','37727',
                          '17669','56082','98053','14609','68858',
                          '19169','36418','75155','32637','27184',
                          '40159','13723','88995','87871','86043',
                          '43873','99047','71677','16037','84359',
                          '19427','80028','22636','38633','28013',
                          '86707','51453','46540','61646','58166',
                          '38471','63429','91189','54227','78955',
                          '22596','55140','74357','38194','74313',
                          '44825','73723','47664','38508','78829',
                          '93496','76048','15143','27771','49449',
                          '57800','70899','41041','71248','50932',
                          '20903','62832','84801','77321','76994',
                          '84567','98649','86323','46209','92546',
                          '69430','19213','50306','46530','93930',
                          '28823','56362','35128','63697','93972',
                          '87654','16695','97082','16919','48893',
                          '64411','71399','82432','23371','77481',
                          '82791','31781','32502','81638','36987',
                          '20141','14768','51081','80790','92795',
                          '65931','68002','99724','50063','85490',
                          '30207','19126','54825','35912','90126',
                          '35627','48918','95470','41383','84371',
                          '86288','35070','45211','55244','64017',
                          '56478','13269','11819','27855','45605',
                          '94407','93234','15118','16653','75810',
                          '10235','46832','68175','84399','48122',
                          '38669','57409','83738','38397','44453',
                          '20634','70855','10846','63726')
     intersect
      select ca_zip
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-05-11' as date) and dateadd(day,60,cast('2001-05-11' as date))
 and i_manufact_id in (376,702,199,290)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2000-03-31' as date) 
 				and dateadd(day,30,cast('2000-03-31' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-06-22','2000-09-16','2000-11-15')))
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 7 or
             household_demographics.hd_vehicle_count= 4)
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Paradise','Jordan')
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,9,7,10,1,11) and
       d_year = 2001 and
       ca_state in ('MS','MI','IN','ND','CO','ID','KS')
 )
