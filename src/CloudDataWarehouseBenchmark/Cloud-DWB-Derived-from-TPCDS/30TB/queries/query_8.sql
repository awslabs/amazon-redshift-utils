...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('1999-05-13' as date) and dateadd(day,60,cast('1999-05-13' as date))
 and i_manufact_id in (737,959,889,859)
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 29512 and 29512+28800 
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-23' as date) 
                  and dateadd(day,30,cast('2001-08-23' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
where 
	...
	and d_date between cast('2001-05-29' as date) 
				and dateadd(day,30,cast('2001-05-29' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-05-20' as date))
...
and cc_county in ('Maverick County','Luce County','Mesa County','Pennington County',
                  'Sierra County'
)
and exists (select *
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-13' as date) 
                  and dateadd(day,14,cast('1999-08-13' as date))
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Mercer County','Dutchess County','Wilkinson County','Green Lake County')
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Highland'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  35478
   and ib_upper_bound   <=  35478 + 50000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('gainsboro','cornsilk','lime','sienna','cream','indian') and
 ...
 where i_manufact_id between 967 and 967+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'white' or i_color = 'orange') and 
...
and d_date between '1998-02-12' and 
        dateadd(day,90,cast('1998-02-12' as date))
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Colorado County','Logan County','Monroe County','Fairfax County','Cottonwood County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 668744926
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 1370033741
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 189858417
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 1194886213
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 849028225
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Miller County','Stafford County','Nuckolls County','Ford County',
                           'Wadena County','Reagan County','Van Buren County','Raleigh County')
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-12' as date) 
                  and dateadd(day,30,cast('1998-08-12' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 25 and 25+10
          or ss_coupon_amt between 15535 and 15535+1000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Children','Jewelry','Home') and
          i_class in ('toddlers','earings','curtains/drapes')
         )
      or (i_category in ('Books','Sports','Shoes') and
          i_class in ('parenting','sailing','mens') 
        ))
group by i_category, i_class, i_brand,
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cornflower','firebrick','wheat'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 3
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Cleveland','Harrisburg','Union','Spring Creek','Greenfield') 
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '67501','26547','62746','45241','83267','36056',
                          '19099','64290','87959','48545','49526',
                          '63941','92292','48093','95705','45953',
                          '83937','51990','98707','96100','59027',
                          '13151','30021','66273','14277','62514',
                          '86021','85911','17529','66841','14648',
                          '99004','12779','25851','14052','43562',
                          '91987','52136','84646','82767','55698',
                          '32076','62926','71284','45818','83521',
                          '13636','69705','32376','15420','55475',
                          '94494','67525','96782','38572','13145',
                          '72747','38544','88371','20108','40725',
                          '32843','35298','78535','90105','58933',
                          '82673','22537','15560','20613','27636',
                          '82958','22781','10247','57952','82411',
                          '45777','85822','68394','90370','99379',
                          '11172','11413','26582','56844','84920',
                          '12733','76527','98774','57927','29948',
                          '30052','22700','53936','80012','14253',
                          '61114','86576','36008','29584','36678',
                          '80964','43481','99323','73892','25078',
                          '66343','65153','48969','83887','32181',
                          '16237','42983','62496','36931','70832',
                          '42510','46367','81703','99504','82530',
                          '38452','42084','87483','54367','20802',
                          '63299','26011','54024','33864','88645',
                          '96498','63871','86969','97822','73846',
                          '99601','59509','38205','76056','70516',
                          '46196','55986','43848','69161','39645',
                          '15912','29594','40668','63908','10687',
                          '85580','50400','92187','11191','80441',
                          '68881','89430','45271','45598','43378',
                          '27998','79776','19507','17951','53775',
                          '40832','21903','56690','34171','11157',
                          '26094','10298','33683','42982','38032',
                          '97879','74774','33394','11980','59484',
                          '36285','46452','47041','92081','84009',
                          '15572','28194','72792','33008','32361',
                          '41147','23436','48104','29517','20160',
                          '57245','33792','18538','43539','82911',
                          '44173','56977','32854','51475','37296',
                          '19906','52284','16164','11004','10274',
                          '26776','73419','25436','22326','53062',
                          '92487','40355','34645','15915','41051',
                          '28530','98108','77287','24053','59104',
                          '59699','66057','85516','90334','33775',
                          '67213','37796','51343','47085','99619',
                          '34621','49892','42866','21247','70740',
                          '70443','97730','12826','10480','74396',
                          '48966','56106','64494','25307','63661',
                          '63163','62499','59071','90755','31686',
                          '58559','79740','49230','67145','85847',
                          '66147','40556','73139','19880','50551',
                          '70759','17910','86598','96413','92851',
                          '44306','87828','19286','81175','25412',
                          '24528','38230','66127','26167','69533',
                          '70804','24522','47703','24852','22969',
                          '70270','23379','55772','84790','69203',
                          '31359','78854','77350','14144','50123',
                          '25482','55120','58090','93782','78405',
                          '10188','29748','42735','46166','17077',
                          '18021','89483','17942','99103','26415',
                          '10680','79753','53881','24225','18929',
                          '85800','92645','68428','25194','60267',
                          '80043','29835','86358','26375','85392',
                          '10375','56261','81259','89290','32727',
                          '16113','84122','62201','36938','70594',
                          '34862','94386','58474','39003','52518',
                          '11494','33228','49985','52478','93186',
                          '64299','73683','63168','35336','28561',
                          '82999','10649','99914','48339','23543',
                          '71332','92196','81775','34477','80125',
                          '23921','21113','45251','69269','10879',
                          '40909','28421','92978','40837','33930',
                          '17940','22017','51841','80082','18347',
                          '66650','59335','17158','71125','60492',
                          '49040','26494','15568','78161','84352',
                          '64287','70781','28601','91582','65627',
                          '78686','29047','77977','69776','42662',
                          '56251','90571','62226','70043')
     intersect
      select ca_zip
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-04-21' as date) and dateadd(day,60,cast('1998-04-21' as date))
 and i_manufact_id in (658,927,26,20)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2002-03-28' as date) 
 				and dateadd(day,30,cast('2002-03-28' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-07-12','2002-08-20','2002-11-07')))
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 6 or
             household_demographics.hd_vehicle_count= 1)
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Hanover','Newtown')
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,8,10,5,9,3) and
       d_year = 2002 and
       ca_state in ('MN','WV','NY','MS','TX','ME','IL')
 )
