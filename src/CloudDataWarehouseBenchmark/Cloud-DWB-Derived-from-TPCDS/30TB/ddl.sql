...
copy store_sales from 's3://redshift-downloads/TPC-DS/30TB/store_sales/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1';
copy catalog_sales from 's3://redshift-downloads/TPC-DS/30TB/catalog_sales/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy web_sales from 's3://redshift-downloads/TPC-DS/30TB/web_sales/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy web_returns from 's3://redshift-downloads/TPC-DS/30TB/web_returns/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy store_returns from 's3://redshift-downloads/TPC-DS/30TB/store_returns/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy catalog_returns from 's3://redshift-downloads/TPC-DS/30TB/catalog_returns/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy call_center from 's3://redshift-downloads/TPC-DS/30TB/call_center/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy catalog_page from 's3://redshift-downloads/TPC-DS/30TB/catalog_page/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy customer_address from 's3://redshift-downloads/TPC-DS/30TB/customer_address/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy customer from 's3://redshift-downloads/TPC-DS/30TB/customer/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy customer_demographics from 's3://redshift-downloads/TPC-DS/30TB/customer_demographics/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy date_dim from 's3://redshift-downloads/TPC-DS/30TB/date_dim/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy household_demographics from 's3://redshift-downloads/TPC-DS/30TB/household_demographics/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy income_band from 's3://redshift-downloads/TPC-DS/30TB/income_band/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy inventory from 's3://redshift-downloads/TPC-DS/30TB/inventory/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
copy item from 's3://redshift-downloads/TPC-DS/30TB/item/' credentials 'aws_access_key_id=<USER_ACCESS_KEY_ID> ;aws_secret_access_key=<USER_SECRET_ACCESS_KEY>' gzip delimiter '|' COMPUPDATE ON  region 'us-east-1' ;
