...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 964 and 964+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'hot' or i_color = 'chartreuse') and 
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('1999-06-06' as date))
                    and dateadd(day,30,cast ('1999-06-06' as date))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,5,11,3,8,10) and
       d_year = 1999 and
       ca_state in ('GA','OK','KY','LA','TX','NH','WV')
 )
...
and d_date between '2001-02-23' and 
        dateadd(day,90,cast('2001-02-23' as date))
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 18403 and 18403+28800 
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('1998-05-28' as date) 
 				and dateadd(day,30,cast('1998-05-28' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2002-04-27' as date) and dateadd(day,60,cast('2002-04-27' as date))
 and i_manufact_id in (592,492,400,480)
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-05-01' as date) and dateadd(day,60,cast('2002-05-01' as date))
 and i_manufact_id in (712,948,979,675)
 and inv_quantity_on_hand between 100 and 500
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lawn','lavender','royal','blue','cyan','spring') and
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 10056 and 10056+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 80 and 80+10
          or ss_coupon_amt between 17668 and 17668+1000
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Buena Vista'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  40429
   and ib_upper_bound   <=  40429 + 50000
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Wayne County','Tazewell County','King County','Geneva County','Marion County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
and cc_county in ('Franklin Parish','Kittitas County','Jefferson Davis Parish','Walker County',
                  'Huron County'
)
and exists (select *
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-19' as date) 
                  and dateadd(day,14,cast('2001-08-19' as date))
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Harmon County','Saginaw County','Walker County','Wadena County',
                           'Mesa County','Essex County','Richland County','Sierra County')
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1999-02-02' as date))
                and dateadd(day,30,cast ('1999-02-02' as date))
 group by
    w_state,i_item_id
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Marshall County','Levy County','Kittitas County','Sumner County')
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('salmon','coral','burlywood'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 4
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-06-12','2002-08-15','2002-11-05')))
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Shady Grove','Oak Ridge')
...
where 
	...
	and d_date between cast('2001-05-24' as date) 
				and dateadd(day,30,cast('2001-05-24' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Music','Men','Electronics') and
          i_class in ('rock','shirts','monitors')
         )
      or (i_category in ('Children','Sports','Shoes') and
          i_class in ('toddlers','pools','mens') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Clifton','Riverview','Stringtown','Woodville','Mount Vernon') 
...
and d_date between '1999-03-12' and 
        dateadd(day,90,cast('1999-03-12' as date))
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 54286959
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 128172808
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 15948959
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 7664642
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 30700090
            then (select avg(ss_ext_discount_amt)
                  from store_sales
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '55450','90516','81277','70764','17234','41349',
                          '95067','28262','74462','95913','84854',
                          '60972','95597','35589','56554','35346',
                          '23514','38334','11919','35908','35353',
                          '35434','14326','32198','58559','88017',
                          '64397','76301','99560','85481','66733',
                          '92758','20993','26222','45543','73029',
                          '99719','44400','77543','83616','76641',
                          '94342','88834','94818','65770','48314',
                          '82084','49404','43470','61534','74626',
                          '71361','12279','44531','53223','31346',
                          '24545','52587','22250','40221','64819',
                          '86063','29059','98980','95439','92571',
                          '67324','68918','64065','62539','10155',
                          '32556','86818','27272','29675','59359',
                          '82324','59936','61136','10904','12463',
                          '21204','31445','33279','84515','80802',
                          '37229','48593','10428','21358','69697',
                          '67373','77506','24532','23244','88161',
                          '83775','81714','44444','51181','62005',
                          '25197','47185','59301','10750','92663',
                          '67578','84199','86089','54082','71251',
                          '98235','58947','69311','55083','62360',
                          '24911','10543','87501','81044','92879',
                          '19586','68063','81721','88712','72769',
                          '20799','44911','58016','46070','78729',
                          '62221','45952','29418','74664','71172',
                          '37889','81943','13616','37823','94684',
                          '94244','53234','82280','19210','79460',
                          '11820','64499','86547','72145','45904',
                          '96972','11792','72997','62144','33012',
                          '43403','86785','11817','98357','40801',
                          '41087','67539','38940','91012','84379',
                          '35226','13936','85945','49641','10658',
                          '83360','74443','94021','65796','82984',
                          '16210','50069','18052','72519','42170',
                          '73727','13460','48986','73794','54939',
                          '34245','21373','57817','96154','65699',
                          '75098','59078','97143','36108','90272',
                          '27466','51075','91034','49463','68627',
                          '97202','67213','26841','19255','33825',
                          '19588','28422','65378','57737','20855',
                          '68159','39130','20120','88282','74163',
                          '94773','17987','41375','48068','97405',
                          '65685','13428','88584','75122','11249',
                          '16065','92361','38576','33573','21891',
                          '28164','60504','75558','76901','82091',
                          '17700','38328','29126','46344','93429',
                          '33926','30575','53925','84706','46506',
                          '37564','29506','99596','50471','98091',
                          '61371','97119','66179','70749','67094',
                          '71837','32564','49005','66531','87958',
                          '26558','42985','29450','21875','40367',
                          '19639','45002','90766','57463','11383',
                          '83514','13921','75067','39842','13343',
                          '71199','20952','11797','24334','89837',
                          '21641','86931','80518','71144','83367',
                          '94849','32896','96636','48400','82595',
                          '56813','84704','57959','60758','34285',
                          '37929','73127','17691','22778','18438',
                          '65441','87706','39171','82488','67786',
                          '47591','65591','14287','88340','26673',
                          '80626','10012','16978','21845','71569',
                          '25463','34443','24797','22252','93498',
                          '94304','61495','70119','98548','31005',
                          '60067','29606','17427','83889','45365',
                          '56231','28753','83825','96337','53893',
                          '95221','24308','81797','13898','53782',
                          '91319','45335','81675','43071','56892',
                          '71961','89321','92661','14715','51669',
                          '30767','40863','72373','36321','89451',
                          '52498','35303','10449','26715','60142',
                          '20180','45873','71372','20334','97638',
                          '98237','45614','89517','93468','86284',
                          '56119','54328','18249','75229','88157',
                          '54376','19676','86934','99653','75729',
                          '57076','62264','65637','56464','24214',
                          '23028','72100','79438','64628','52988',
                          '34129','52373','37013','23803','67789',
                          '27591','81464','26887','40759')
     intersect
      select ca_zip
