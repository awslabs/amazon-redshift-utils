...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-22' as date) 
                  and dateadd(day,14,cast('2001-08-22' as date))
...
and d_date between '1999-03-20' and 
        dateadd(day,90,cast('1999-03-20' as date))
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('1998-03-15' as date))
                    and dateadd(day,30,cast ('1998-03-15' as date))
...
where 
	...
	and d_date between cast('2001-03-27' as date) 
				and dateadd(day,30,cast('2001-03-27' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('1999-05-31' as date) 
 				and dateadd(day,30,cast('1999-05-31' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       d_year = 2002 and
       ca_state in ('KS','MS','NJ','IN','OK','TX','UT')
 )
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2000-03-07' as date))
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-30' as date) and dateadd(day,60,cast('2002-03-30' as date))
