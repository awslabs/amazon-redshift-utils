...
;
set query_group to 'TPC-DS query39.1.tpl stream.0.5';
with inv as
(select w_warehouse_name,w_warehouse_sk,i_item_sk,d_moy
       ,stdev,mean, case mean when 0 then null else stdev/mean end cov
 from(select w_warehouse_name,w_warehouse_sk,i_item_sk,d_moy
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 111823211
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 35224284
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 22816501
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 56475639
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 43543208
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Shoes','Jewelry','Music') and
          i_class in ('womens','costume','country')
         )
      or (i_category in ('Children','Electronics','Books') and
          i_class in ('newborn','monitors','entertainments') 
        ))
group by i_category, i_class, i_brand,
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 932 and 932+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'midnight' or i_color = 'dark') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '50342','99032','27958','73713','32604','88542',
                          '32009','33786','80591','73206','33044',
                          '33269','49456','94443','28619','75819',
                          '69210','51658','14411','45885','74362',
                          '42254','25218','32034','61578','58092',
                          '48531','46083','41721','59762','78664',
                          '20541','58825','94267','21282','53305',
                          '59492','14659','91363','95700','13826',
                          '62061','40540','92492','38654','79274',
                          '27170','90868','39519','55949','29021',
                          '23142','59298','83227','87667','27166',
                          '11554','31115','40341','58360','82395',
                          '11172','35116','83154','48712','96830',
                          '10294','19606','80070','11108','86492',
                          '32987','12043','79696','70210','12458',
                          '61865','46252','17612','61360','37056',
                          '48403','49163','97735','24310','42376',
                          '15534','86216','50761','50090','50932',
                          '67939','37579','43394','41840','29801',
                          '64741','12472','77798','58165','88778',
                          '26510','34059','14981','18738','59430',
                          '83703','53012','86298','70257','89168',
                          '46839','69725','18608','16772','98377',
                          '56593','43161','10424','47464','97677',
                          '96230','48042','26497','15058','70435',
                          '27946','97284','71167','66000','45844',
                          '82902','12974','98066','23990','56215',
                          '26731','16413','39441','12133','91702',
                          '20358','11747','76812','66775','18142',
                          '66247','87011','81673','58213','31367',
                          '32341','81933','31638','50816','61006',
                          '61856','15853','17264','38616','91666',
                          '60609','46662','86108','44879','30281',
                          '16352','57660','35055','51791','28385',
                          '86234','95835','10184','96425','28046',
                          '27900','25098','25458','91308','21053',
                          '19571','53575','86336','45818','32629',
                          '76199','33384','27817','36199','56007',
                          '79289','97946','99659','47717','22170',
                          '25150','58505','88445','43141','99519',
                          '60131','97858','92837','35145','33886',
                          '17730','88229','85510','52306','40509',
                          '77556','22896','91531','30464','82431',
                          '66948','35014','44209','63063','63263',
                          '12638','74455','22199','68230','21841',
                          '10601','79788','24862','56372','71755',
                          '87600','39080','21843','26270','82759',
                          '57232','55994','25300','17354','60684',
                          '97187','86837','98354','31465','92389',
                          '74415','57329','57698','66732','46605',
                          '71355','91150','54622','49420','47736',
                          '66801','11382','35609','12504','10220',
                          '74049','60631','55816','85828','78343',
                          '52689','10278','83401','90667','99142',
                          '61272','30128','21642','94003','45232',
                          '15216','71565','52044','71209','26205',
                          '83655','86714','37584','62918','50830',
                          '69974','17225','20640','58085','63852',
                          '10661','65230','37008','83041','90895',
                          '26560','64661','46469','66788','56875',
                          '11702','64013','32851','46097','76383',
                          '78450','88962','92460','29148','99535',
                          '76256','34300','95004','54057','48653',
                          '41069','56711','16942','41712','60516',
                          '34395','76189','19272','65797','72103',
                          '50173','57737','48265','94270','73475',
                          '29872','39631','48719','85543','22332',
                          '19319','66668','42284','21032','16257',
                          '84031','45275','77064','48957','59998',
                          '99140','57814','95119','93733','15573',
                          '35536','89999','53403','62995','26292',
                          '17127','27325','19573','88336','89551',
                          '24896','21266','34501','65294','93822',
                          '80001','90850','20466','36679','51071',
                          '52685','68309','88149','40016','56796',
                          '62441','93402','74965','17678','78813',
                          '75381','57718','25023','64449','16560',
                          '35427','30452','74592','17723','72852',
                          '13685','91633','31940','21327','13284',
                          '72990','47561','29270','70841')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-15' as date) and (cast('2002-03-15' as date) +  60 )
 and i_manufact_id in (354,112,907,306)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
from
 ...
 limit 100;
set query_group to 'TPC-DS query23.1.tpl stream.0.68'; 
with frequent_ss_items as
 (select substring(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  from store_sales
      ,date_dim
...
order by channel, i_brand_id, i_class_id, i_category_id
 limit 100;
set query_group to 'TPC-DS query14a.1.tpl stream.0.69'; 
with  cross_items as
 (select i_item_sk ss_item_sk
 from item,
 (select iss.i_brand_id brand_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Levy County','Terry County','Arthur County','Sumner County',
                           'Essex County','Contra Costa County','Franklin Parish','Orange County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Daviess County','Appanoose County','Raleigh County','Mobile County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Midway'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  10776
   and ib_upper_bound   <=  10776 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('pink','thistle','floral'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 1
...
with results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,11,5,6,8,4) and
       d_year = 1998 and
       ca_state in ('TX','LA','MN','IL','OH','MT','UT')
 )
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MO', 'MI', 'NE')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AZ', 'NY', 'KY')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('CA', 'NJ', 'MN')
...
order by c_last_name
        ...
        ,s_store_name
;
set query_group to 'TPC-DS query24.1.tpl stream.0.92';
with ssales as
(select c_last_name
      ,c_first_name
      ,s_store_name
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-03-18','2001-09-09','2001-11-09')))
