...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('1998-02-14' as date) and dateadd(day,60,cast('1998-02-14' as date))
...
with /* TPC-DS query80a.tpl 0.6 */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-19' as date) 
                  and dateadd(day,30,cast('1999-08-19' as date)) 
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
where 
	...
	and d_date between cast('1999-06-25' as date) 
				and dateadd(day,30,cast('1999-06-25' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2000-03-21' as date))
                and dateadd(day,30,cast ('2000-03-21' as date))
 group by
    w_state,i_item_id
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-29' as date) 
                  and dateadd(day,14,cast('1999-08-29' as date))
...
and d_date between '2002-02-03' and 
        dateadd(day,90,cast('2002-02-03' as date))
...
and d_date between '2002-03-27' and 
        dateadd(day,90,cast('2002-03-27' as date))
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-03-21' as date) and dateadd(day,60,cast('2000-03-21' as date))
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2002-01-22' as date) 
 				and dateadd(day,30,cast('2002-01-22' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       d_year = 1998 and
       ca_state in ('VA','NC','IA','NV','KY','MI','MO')
 )
