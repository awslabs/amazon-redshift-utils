...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('pale','orchid','khaki'))
...
where 
	...
	and d_date between cast('2000-02-20' as date) 
				and dateadd(day,30,cast('2000-02-20' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-05-20','2000-10-08','2000-11-09')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 154 and 154+10 
             or ss_coupon_amt between 15031 and 15031+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 148 and 148+10
          or ss_coupon_amt between 11456 and 11456+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 64 and 64+10
          or ss_coupon_amt between 10630 and 10630+1000
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Mountain View','Arlington')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '93376','49708','81007','50105','62856','19642',
                          '18268','70949','43695','84123','24595',
                          '20316','60189','41147','27811','64803',
                          '83120','93516','33155','26099','18367',
                          '25325','60620','14375','27786','10791',
                          '25240','99616','74212','28081','78906',
                          '28716','25054','14952','72330','26386',
                          '75373','78493','49815','52404','61920',
                          '29187','88144','24686','68308','84982',
                          '58290','36796','20252','42227','16078',
                          '61197','94914','58284','81878','75917',
                          '25387','63396','43096','14869','94051',
                          '78692','43263','52298','39766','29936',
                          '50895','15460','29370','58242','42191',
                          '93023','30516','88350','88794','44138',
                          '33840','66162','88621','75240','86184',
                          '54765','63939','27516','64963','65583',
                          '98451','25034','87874','43471','87587',
                          '84069','50468','85793','90945','12634',
                          '34350','66275','41020','10006','24907',
                          '31279','69585','59816','75350','29697',
                          '29499','44784','23765','14994','72359',
                          '97726','97071','91021','50048','71479',
                          '72769','96385','25756','46143','42573',
                          '10669','39652','69491','25662','39949',
                          '62950','34273','88554','24568','62226',
                          '28559','76234','14226','65046','51901',
                          '93909','32763','11327','35395','99859',
                          '92170','50419','54217','89346','12331',
                          '89790','26693','62171','32841','84996',
                          '35084','75031','32892','47684','26865',
                          '70587','58665','12375','31107','68536',
                          '79121','27444','50673','61073','37608',
                          '68992','89513','74017','29541','36383',
                          '71296','40709','14991','22108','13924',
                          '88231','79645','67410','56428','34233',
                          '39253','62701','54233','24634','94269',
                          '87981','37973','39816','78899','61552',
                          '55233','42307','33800','14538','25229',
                          '15438','67144','68132','45201','73064',
                          '19674','49809','85510','75715','96666',
                          '36938','71177','11323','66722','72737',
                          '12821','70305','20733','76345','87387',
                          '41100','62960','52242','89219','99087',
                          '96196','15530','19145','67240','80150',
                          '88176','38517','57480','66090','81100',
                          '46706','71128','83529','82831','37904',
                          '51284','53288','98254','40895','67405',
                          '15476','28233','94910','65115','98996',
                          '60434','83290','79891','60925','78114',
                          '34832','48897','42032','12142','71537',
                          '81009','21692','99393','35660','41962',
                          '67344','10575','82996','98639','14665',
                          '56901','55536','80382','71337','46506',
                          '62790','80737','10483','24567','32558',
                          '56371','65793','83676','83743','85552',
                          '38887','84916','76232','16994','85041',
                          '37359','90513','46000','15362','83812',
                          '48592','57525','81117','10157','44592',
                          '94111','96389','27153','13803','24745',
                          '20944','77124','99242','72464','15535',
                          '90928','14199','39927','77971','10273',
                          '87435','38334','62507','74712','11216',
                          '77315','62793','74030','87290','24331',
                          '55409','62313','13182','83035','46890',
                          '51434','73705','12657','74009','48281',
                          '44005','25503','32217','92016','47734',
                          '89720','82221','19712','59128','96197',
                          '28861','47263','51417','77690','62291',
                          '34838','63197','20377','66057','76195',
                          '41534','89261','18798','76270','64354',
                          '81990','69756','50465','32641','66102',
                          '38372','40105','88415','91560','52679',
                          '34460','32727','22455','36745','57234',
                          '24786','27261','86312','60659','10268',
                          '73990','59887','25117','95826','26720',
                          '17191','76982','63239','28922','63662',
                          '61493','95062','66542','37827','98613',
                          '54876','55793','56844','46286','72202',
                          '79904','90354','29809','32097')
     intersect
      select ca_zip
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-26' as date) 
                  and dateadd(day,30,cast('2001-08-26' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('2001-05-29' as date))
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Grant County','Bee County','Ward County','Wayne County','Faribault County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and i_manufact_id in (109,105,122,377)
...
and cc_county in ('Marshall County','San Miguel County','Luce County','Mesa County',
                  'Williamson County'
)
and exists (select *
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Appanoose County','Kittitas County','Furnas County','Huron County')
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Forest Hills'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  42816
   and ib_upper_bound   <=  42816 + 50000
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-10' as date) and dateadd(day,60,cast('1998-06-10' as date))
 and i_manufact_id in (737,937,809,899)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('green','medium','chiffon','blush','sandy','olive') and
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 421957040
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 460629212
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 351417265
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 427128584
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 264121245
            then (select avg(ss_ext_tax)
                  from store_sales
...
and d_date between '2002-01-16' and 
        dateadd(day,90,cast('2002-01-16' as date))
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,5,8,11,12,3) and
       d_year = 1998 and
       ca_state in ('MO','TX','VA','AR','AL','WI','OH')
 )
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Wadena County','Pipestone County','Saginaw County','Williamson County',
                           'Walker County','Jackson County','Ziebach County','West Feliciana Parish')
...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 708 and 708+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'pale' or i_color = 'azure') and 
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'grey' or i_color = 'white') and 
        ...
        (i_category = 'Men' and
        (i_color = 'cyan' or i_color = 'sienna') and
...
and d_date between '2002-03-09' and 
        dateadd(day,90,cast('2002-03-09' as date))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Springdale','Cross Roads','Summit','Antioch','Lakewood') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Men','Sports','Books') and
          i_class in ('accessories','athletic shoes','entertainments')
         )
      or (i_category in ('Music','Children','Home') and
          i_class in ('country','toddlers','rugs') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 50797 and 50797+28800 
