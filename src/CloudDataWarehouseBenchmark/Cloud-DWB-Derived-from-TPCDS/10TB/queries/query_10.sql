...
set query_group to 'TPC-DS query43.tpl stream.10.1';
...
set query_group to 'TPC-DS query50.tpl stream.10.2';
...
set query_group to 'TPC-DS query41.tpl stream.10.3';
...
set query_group to 'TPC-DS query48.tpl stream.10.4';
...
set query_group to 'TPC-DS query54.tpl stream.10.5';
...
set query_group to 'TPC-DS query53.tpl stream.10.6';
...
set query_group to 'TPC-DS query31.tpl stream.10.7';
...
set query_group to 'TPC-DS query39.tpl stream.10.8';
...
set query_group to 'TPC-DS query2.tpl stream.10.9';
...
set query_group to 'TPC-DS query96.tpl stream.10.10';
...
set query_group to 'TPC-DS query93.tpl stream.10.11';
...
set query_group to 'TPC-DS query15.tpl stream.10.12';
...
set query_group to 'TPC-DS query91.tpl stream.10.13';
...
set query_group to 'TPC-DS query21.tpl stream.10.14';
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('2000-04-15' as date))
                    and dateadd(day,30,cast ('2000-04-15' as date))
...
set query_group to 'TPC-DS query18a.tpl stream.10.15';
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,11,1,5,7,8) and
       d_year = 1999 and
       ca_state in ('NY','TN','OH','LA','UT','AR','MN')
 )
...
-- end query 15 in stream 10 using template query18a.tpl
set query_group to 'TPC-DS query32.tpl stream.10.16';
...
set query_group to 'TPC-DS query63.tpl stream.10.17';
...
set query_group to 'TPC-DS query24.tpl stream.10.18';
...
set query_group to 'TPC-DS query66.tpl stream.10.19';
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 4244 and 4244+28800 
...
set query_group to 'TPC-DS query70a.tpl stream.10.20';
...
-- end query 20 in stream 10 using template query70a.tpl
set query_group to 'TPC-DS query36a.tpl stream.10.21';
...
-- end query 21 in stream 10 using template query36a.tpl
set query_group to 'TPC-DS query20.tpl stream.10.22';
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('1999-01-13' as date) 
 				and dateadd(day,30,cast('1999-01-13' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
set query_group to 'TPC-DS query30.tpl stream.10.23';
...
set query_group to 'TPC-DS query25.tpl stream.10.24';
...
set query_group to 'TPC-DS query7.tpl stream.10.25';
...
set query_group to 'TPC-DS query1.tpl stream.10.26';
...
set query_group to 'TPC-DS query98.tpl stream.10.27';
...
set query_group to 'TPC-DS query69.tpl stream.10.28';
...
set query_group to 'TPC-DS query47.tpl stream.10.29';
...
set query_group to 'TPC-DS query94.tpl stream.10.30';
...
set query_group to 'TPC-DS query82.tpl stream.10.31';
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2000-05-09' as date) and dateadd(day,60,cast('2000-05-09' as date))
 and i_manufact_id in (286,149,877,32)
...
set query_group to 'TPC-DS query37.tpl stream.10.32';
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-06-04' as date) and dateadd(day,60,cast('2001-06-04' as date))
 and i_manufact_id in (933,670,795,702)
 and inv_quantity_on_hand between 100 and 500
...
set query_group to 'TPC-DS query64.tpl stream.10.33';
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('cream','cornsilk','orange','dark','blanched','chartreuse') and
...
set query_group to 'TPC-DS query86a.tpl stream.10.34';
...
-- end query 34 in stream 10 using template query86a.tpl
set query_group to 'TPC-DS query87.tpl stream.10.35';
...
set query_group to 'TPC-DS query28.tpl stream.10.36';
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 40 and 40+10
          or ss_coupon_amt between 6366 and 6366+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 128 and 128+10
          or ss_coupon_amt between 13568 and 13568+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 2951 and 2951+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 103 and 103+10
          or ss_coupon_amt between 11045 and 11045+1000
          or ss_wholesale_cost between 0 and 0+20)) B6
limit 100;

-- end query 36 in stream 10 using template query28.tpl
set query_group to 'TPC-DS query55.tpl stream.10.37';
...
set query_group to 'TPC-DS query85.tpl stream.10.38';
...
set query_group to 'TPC-DS query38.tpl stream.10.39';
...
set query_group to 'TPC-DS query44.tpl stream.10.40';
...
set query_group to 'TPC-DS query27a.tpl stream.10.41';
...
-- end query 41 in stream 10 using template query27a.tpl
set query_group to 'TPC-DS query78.tpl stream.10.42';
...
set query_group to 'TPC-DS query45.tpl stream.10.43';
...
set query_group to 'TPC-DS query49.tpl stream.10.44';
...
set query_group to 'TPC-DS query62.tpl stream.10.45';
...
set query_group to 'TPC-DS query59.tpl stream.10.46';
...
set query_group to 'TPC-DS query77a.tpl stream.10.47';
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-20' as date) 
                  and dateadd(day,30,cast('2001-08-20' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- end query 47 in stream 10 using template query77a.tpl
set query_group to 'TPC-DS query80a.tpl stream.10.48';
...
-- end query 48 in stream 10 using template query80a.tpl
set query_group to 'TPC-DS query84.tpl stream.10.49';
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Midway'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  52687
   and ib_upper_bound   <=  52687 + 50000
...
set query_group to 'TPC-DS query67a.tpl stream.10.50';
...
-- end query 50 in stream 10 using template query67a.tpl
set query_group to 'TPC-DS query52.tpl stream.10.51';
...
set query_group to 'TPC-DS query76.tpl stream.10.52';
...
set query_group to 'TPC-DS query42.tpl stream.10.53';
...
set query_group to 'TPC-DS query33.tpl stream.10.54';
...
set query_group to 'TPC-DS query65.tpl stream.10.55';
...
set query_group to 'TPC-DS query23.tpl stream.10.56';
...
set query_group to 'TPC-DS query90.tpl stream.10.57';
...
set query_group to 'TPC-DS query88.tpl stream.10.58';
...
set query_group to 'TPC-DS query99.tpl stream.10.59';
...
set query_group to 'TPC-DS query35.tpl stream.10.60';
...
set query_group to 'TPC-DS query10.tpl stream.10.61';
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Texas County','Tyler County','Shoshone County','Miami County','Talbot County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
set query_group to 'TPC-DS query16.tpl stream.10.62';
...
and cc_county in ('Mobile County','Ziebach County','Mesa County','Dauphin County',
                  'Barrow County'
)
and exists (select *
...
set query_group to 'TPC-DS query5a.tpl stream.10.63';
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-05' as date) 
                  and dateadd(day,14,cast('2001-08-05' as date))
...
-- end query 63 in stream 10 using template query5a.tpl
set query_group to 'TPC-DS query57.tpl stream.10.64';
...
set query_group to 'TPC-DS query34.tpl stream.10.65';
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Orange County','Henry County','San Miguel County','Barrow County',
                           'Furnas County','Mesa County','Franklin Parish','Appanoose County')
...
set query_group to 'TPC-DS query97.tpl stream.10.66';
...
set query_group to 'TPC-DS query72.tpl stream.10.67';
...
set query_group to 'TPC-DS query75.tpl stream.10.68';
...
set query_group to 'TPC-DS query14a.tpl stream.10.69';
...
-- end query 69 in stream 10 using template query14a.tpl
set query_group to 'TPC-DS query40.tpl stream.10.70';
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1999-03-19' as date))
                and dateadd(day,30,cast ('1999-03-19' as date))
 group by
    w_state,i_item_id
...
set query_group to 'TPC-DS query73.tpl stream.10.71';
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Harding County','Kittitas County','Green Lake County','Miller County')
...
set query_group to 'TPC-DS query79.tpl stream.10.72';
...
set query_group to 'TPC-DS query11.tpl stream.10.73';
...
set query_group to 'TPC-DS query6.tpl stream.10.74';
...
set query_group to 'TPC-DS query17.tpl stream.10.75';
...
set query_group to 'TPC-DS query58.tpl stream.10.76';
...
set query_group to 'TPC-DS query56.tpl stream.10.77';
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('turquoise','blue','medium'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 7
...
set query_group to 'TPC-DS query83.tpl stream.10.78';
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-22','2001-08-31','2001-11-15')))
...
set query_group to 'TPC-DS query51.tpl stream.10.79';
...
set query_group to 'TPC-DS query29.tpl stream.10.80';
...
set query_group to 'TPC-DS query22a.tpl stream.10.81';
...
-- end query 81 in stream 10 using template query22a.tpl
set query_group to 'TPC-DS query71.tpl stream.10.82';
...
set query_group to 'TPC-DS query68.tpl stream.10.83';
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Rosedale','Springfield')
...
set query_group to 'TPC-DS query60.tpl stream.10.84';
...
set query_group to 'TPC-DS query12.tpl stream.10.85';
...
where 
	...
	and d_date between cast('1999-05-17' as date) 
				and dateadd(day,30,cast('1999-05-17' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
set query_group to 'TPC-DS query4.tpl stream.10.86';
...
set query_group to 'TPC-DS query89.tpl stream.10.87';
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Children','Books','Home') and
          i_class in ('infants','sports','furniture')
         )
      or (i_category in ('Women','Shoes','Electronics') and
          i_class in ('fragrances','womens','memory') 
        ))
group by i_category, i_class, i_brand,
...
set query_group to 'TPC-DS query61.tpl stream.10.88';
...
set query_group to 'TPC-DS query46.tpl stream.10.89';
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Cross Roads','Oak Grove','Hilltop','Anderson','Newport') 
...
set query_group to 'TPC-DS query92.tpl stream.10.90';
...
and d_date between '1999-02-12' and 
        dateadd(day,90,cast('1999-02-12' as date))
...
set query_group to 'TPC-DS query13.tpl stream.10.91';
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WY', 'NC', 'IA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'TN', 'SC')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NJ', 'KS', 'IN')
  and ss_net_profit between 50 and 250  
     ))
;

-- end query 91 in stream 10 using template query13.tpl
set query_group to 'TPC-DS query9.tpl stream.10.92';
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 128532178
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 221690193
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 245179587
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 66153359
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 179387383
            then (select avg(ss_ext_list_price)
                  from store_sales
...
set query_group to 'TPC-DS query74.tpl stream.10.93';
...
set query_group to 'TPC-DS query8.tpl stream.10.94';
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '38167','79796','99563','28841','47154','31890',
                          '67755','45622','49690','68433','78240',
                          '27907','77164','15986','19252','47797',
                          '92103','18109','79872','95427','46799',
                          '80054','54713','27131','45118','90777',
                          '10309','37911','54871','68529','32599',
                          '75038','43143','68968','50121','81760',
                          '83480','80663','79617','61913','12374',
                          '92533','59441','36320','45912','24410',
                          '86318','70756','33539','88061','60768',
                          '67907','73590','53703','61973','92139',
                          '88934','67190','74025','42883','19843',
                          '34987','58573','69440','84237','44122',
                          '39836','83578','33746','15736','79951',
                          '27373','92522','94191','33102','70107',
                          '34908','41819','53177','60593','41636',
                          '63693','19128','23344','95459','29945',
                          '11566','51037','43197','16221','59021',
                          '97875','76163','22238','84754','34479',
                          '22743','15805','97259','10603','90312',
                          '96488','50668','90357','77101','96175',
                          '11878','21052','58079','52320','64591',
                          '88239','48576','92881','72288','42188',
                          '95188','73701','69945','52031','39527',
                          '18265','23813','59064','55301','46645',
                          '92203','95591','70846','55178','72636',
                          '42410','82984','30313','21555','89841',
                          '69028','81945','44905','78322','29134',
                          '45102','50008','44665','71305','40912',
                          '66827','77759','31023','62211','64207',
                          '39598','38977','72067','12876','90107',
                          '61725','20805','28646','78629','14109',
                          '49188','63084','25205','53785','90401',
                          '71659','96844','53696','93336','57155',
                          '36144','57597','39625','71795','54965',
                          '88357','64930','43119','48941','46705',
                          '87509','66196','54238','44712','80243',
                          '91266','14829','82639','77331','93860',
                          '73338','45196','77559','34956','17686',
                          '68224','12032','40822','51425','11098',
                          '77634','58133','40142','83493','10974',
                          '93947','65943','55598','91217','39331',
                          '99769','88548','77107','92975','75930',
                          '49720','79664','15844','60852','91341',
                          '31328','70044','48934','29206','45055',
                          '68502','16303','64861','43968','37711',
                          '22305','61208','55698','37108','20492',
                          '19010','86264','43128','63245','52753',
                          '57740','75187','51772','98135','61699',
                          '61566','86718','83249','39874','14538',
                          '90038','59200','38433','94658','98355',
                          '63429','93495','82450','73641','29530',
                          '69178','63065','89683','31017','57581',
                          '62582','28112','74585','47162','22981',
                          '61202','72349','38514','30900','44275',
                          '97775','44270','22391','56158','58343',
                          '39714','25638','33536','97388','97510',
                          '30977','83619','33403','80591','26421',
                          '62485','92445','29309','37364','20946',
                          '92317','57336','64014','90240','93162',
                          '22780','37859','73727','10865','93144',
                          '16750','45113','37240','96034','59671',
                          '27248','86689','74087','31237','17832',
                          '54561','30762','96729','87346','25531',
                          '83830','29102','75184','87112','42758',
                          '24508','57292','57453','29546','31217',
                          '33989','98296','59870','95957','22469',
                          '84638','94417','41162','47382','64746',
                          '54611','29091','50407','75936','74290',
                          '94350','86107','36454','29794','20312',
                          '98919','89061','33322','15891','92001',
                          '27853','65112','41780','99847','58789',
                          '64208','54927','61245','84999','90532',
                          '17439','43293','11512','46733','73469',
                          '20634','68108','97926','67238','86374',
                          '21991','95171','12731','56359','64173',
                          '22352','41538','82248','61436','78169',
                          '25912','96272','36857','54689','21751',
                          '54613','34418','26268','93641','43639',
                          '31975','42041','96318','81618')
     intersect
      select ca_zip
...
set query_group to 'TPC-DS query3.tpl stream.10.95';
...
set query_group to 'TPC-DS query95.tpl stream.10.96';
...
set query_group to 'TPC-DS query26.tpl stream.10.97';
...
set query_group to 'TPC-DS query81.tpl stream.10.98';
...
set query_group to 'TPC-DS query19.tpl stream.10.99';
