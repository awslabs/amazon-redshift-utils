...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-02-21','1998-08-14','1998-11-02')))
...
and d_date between '1999-01-20' and 
        dateadd(day,90,cast('1999-01-20' as date))
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 27217 and 27217+28800 
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Spring Hill'
   ...
   and ib_lower_bound   >=  52626
   and ib_upper_bound   <=  52626 + 50000
...
where 
	...
	and d_date between cast('1998-04-21' as date) 
				and dateadd(day,30,cast('1998-04-21' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and cc_county in ('Oglethorpe County','Gogebic County','Walker County','Kittitas County',
                  'Marshall County'
)
and exists (select *
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 72 and 72+10
          or ss_coupon_amt between 5460 and 5460+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 50 and 50+10
          or ss_coupon_amt between 10917 and 10917+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 12 and 12+10
          or ss_coupon_amt between 4520 and 4520+1000
...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 952 and 952+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'peach' or i_color = 'sandy') and 
        ...
        (i_category = 'Men' and
        (i_color = 'snow' or i_color = 'pale') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'white' or i_color = 'royal') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '32334','39301','61392','53640','29725','38704',
                          '71472','33403','74777','97403','59917',
                          '58251','88229','30200','22055','26772',
                          '86853','99594','19411','37878','34116',
                          '51238','92086','20900','95914','12407',
                          '78573','33512','83806','46184','21041',
                          '15945','68026','43910','62655','53425',
                          '70990','17523','39802','48480','73059',
                          '52196','38134','67864','31932','64982',
                          '70149','75127','25667','88051','56751',
                          '24962','64417','29796','66542','62278',
                          '48968','40212','69528','62938','73344',
                          '26596','96491','27275','83992','17303',
                          '52241','81015','81713','53933','69347',
                          '48545','75698','29066','99949','21873',
                          '62363','24829','11845','72781','62096',
                          '87074','63230','57817','29569','29772',
                          '82902','89358','76161','57917','92630',
                          '96670','87325','28934','77165','55006',
                          '21547','41796','14830','53660','93864',
                          '11605','39502','51126','42632','34246',
                          '18190','51995','47862','96553','22995',
                          '93807','40950','43080','73327','89333',
                          '95320','95333','49052','49159','24506',
                          '68252','22214','48064','58077','55247',
                          '64070','85101','30706','25436','85826',
                          '27845','17698','48345','10055','88732',
                          '98133','19142','34277','98896','17359',
                          '32020','73362','13859','86921','46377',
                          '72453','43249','53907','47925','79142',
                          '56195','25723','51671','64657','62760',
                          '93186','27715','30189','40955','39792',
                          '96038','63214','53255','17235','39065',
                          '17123','71477','51879','30301','16750',
                          '67950','69511','60717','73306','20347',
                          '47430','83504','30864','32538','54718',
                          '26698','91182','82334','58613','30569',
                          '65447','48847','59294','35912','12004',
                          '36240','34710','38185','40350','71887',
                          '16089','72803','44923','74006','12359',
                          '30999','61140','38159','59610','93516',
                          '42252','98797','76952','95142','26536',
                          '33011','16566','45864','65250','55748',
                          '58157','19786','77406','97536','58612',
                          '76262','69574','92054','30634','28724',
                          '56607','43590','45480','34446','19622',
                          '49100','52583','28150','33825','27843',
                          '73412','56228','53802','57606','33057',
                          '77244','13039','75042','52549','34161',
                          '80308','30434','58377','66184','34249',
                          '40490','52535','59759','39362','18945',
                          '18302','33056','52775','25647','28399',
                          '72540','98355','84799','69834','49220',
                          '98249','35875','42672','12357','19501',
                          '29816','64246','53672','21008','29380',
                          '66193','75694','18068','74398','73198',
                          '46517','31659','22914','59314','63313',
                          '16512','58162','73222','71463','37044',
                          '71856','85281','13564','80778','17171',
                          '55131','68897','99051','48520','43537',
                          '32893','98856','63439','75470','15804',
                          '81095','57441','85223','50185','94545',
                          '56845','83929','15172','82274','74634',
                          '59539','78588','72099','47358','86626',
                          '60596','82901','61471','11652','88334',
                          '98526','10586','98423','35632','82912',
                          '94725','94059','17570','52185','60103',
                          '12496','36888','86603','74731','21201',
                          '51733','98100','66498','66404','82094',
                          '15325','83159','68826','44269','37726',
                          '25442','37654','52120','87368','63541',
                          '39685','29685','68240','15359','36744',
                          '80032','15356','38405','17791','45153',
                          '30402','46114','63719','26630','36902',
                          '81188','94841','52307','73518','25050',
                          '34261','70123','87222','26403','24435',
                          '28059','36205','30491','76867','83187',
                          '47887','83677','38986','90843','24674',
                          '50483','54491','68474','55258','71553',
                          '77500','77810','30769','39659')
     intersect
      select ca_zip
...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-18' as date) 
                  and dateadd(day,14,cast('1999-08-18' as date))
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and i_manufact_id in (290,153,427,728)
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,5,6,4,8,9) and
       d_year = 1999 and
       ca_state in ('AL','CA','GA','MT','WV','UT','NY')
 )
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Hopewell','Dixie')
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 404089477
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 217972978
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 72067079
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 130454260
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 185749300
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-01-24' as date) and dateadd(day,60,cast('2000-01-24' as date))
 and i_manufact_id in (961,998,684,975)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navajo','chiffon','plum','royal','tomato','white') and
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Clifton','Cross Roads','Milltown','Clinton','Independence') 
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('1999-04-09' as date))
                    and dateadd(day,30,cast ('1999-04-09' as date))
...
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2002-04-19' as date) 
 				and dateadd(day,30,cast('2002-04-19' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Harmon County','Karnes County','Raleigh County','Essex County',
                           'Pulaski County','Maverick County','Gage County','Mariposa County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Women','Sports','Shoes') and
          i_class in ('maternity','football','mens')
         )
      or (i_category in ('Music','Children','Books') and
          i_class in ('pop','infants','arts') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Gratiot County','Henry County','Salt Lake County','Deer Lodge County','Crittenden County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Salem County','Contra Costa County','Gogebic County','Nowata County')
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('black','rose','cornflower'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 5
