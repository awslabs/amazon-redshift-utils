...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Abbeville County','Green Lake County','Levy County','Anderson County',
                           'Oglethorpe County','Klamath County','Gogebic County','Warren County')
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Kittitas County','Jefferson Davis Parish','Henry County','Harper County')
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1313990
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 122678799
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 474078611
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 97614937
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 48577962
            then (select avg(ss_ext_tax)
                  from store_sales
...
and d_date between '2000-01-17' and 
        dateadd(day,90,cast('2000-01-17' as date))
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Sports','Men','Jewelry') and
          i_class in ('golf','accessories','custom')
         )
      or (i_category in ('Women','Music','Electronics') and
          i_class in ('swimwear','rock','automotive') 
        ))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 102 and 102+10 
             or ss_coupon_amt between 5838 and 5838+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 107 and 107+10
          or ss_coupon_amt between 17045 and 17045+1000
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,7,8,4,9,12) and
       d_year = 2001 and
       ca_state in ('MO','KY','GA','OH','VA','IL','MN')
 )
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Stringtown'
   ...
   and ib_lower_bound   >=  43393
   and ib_upper_bound   <=  43393 + 50000
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('1998-06-11' as date) and dateadd(day,60,cast('1998-06-11' as date))
 and i_manufact_id in (325,527,274,243)
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '43027','36467','15575','46557','17485','66133',
                          '48379','40942','84354','52703','66991',
                          '56952','61472','34483','54434','59459',
                          '87083','61867','83414','38353','10835',
                          '29318','64355','74905','88840','49239',
                          '77068','16982','63890','64844','23818',
                          '33516','74222','31691','23796','19551',
                          '51345','49326','81028','37269','65264',
                          '50261','77179','43116','96255','54150',
                          '25814','22866','49134','53756','72694',
                          '59148','91713','17475','18305','28155',
                          '48567','41316','47892','52773','16819',
                          '91586','62602','60618','62130','93832',
                          '40424','64853','97054','24314','43319',
                          '27191','27682','27722','35246','69577',
                          '18548','32226','95580','22418','39572',
                          '77645','98647','34954','10760','17214',
                          '59556','24886','90465','56022','80865',
                          '81555','18923','83689','56972','32075',
                          '99088','39321','12348','13087','32868',
                          '35748','72434','13414','76440','33169',
                          '26327','59810','28092','69859','90728',
                          '27372','77874','43948','27546','90711',
                          '57747','20584','79167','74684','78348',
                          '28906','31141','54711','89279','35828',
                          '98524','43556','20707','49305','52981',
                          '60918','38620','38644','45321','42369',
                          '99407','50087','47187','38746','81757',
                          '45859','83275','88154','21838','73693',
                          '87184','25405','53555','96707','35462',
                          '26660','59587','77501','82024','63186',
                          '63916','95056','76859','63327','87088',
                          '48321','78902','56158','29168','57099',
                          '78322','11580','70080','89113','25052',
                          '69927','89398','62509','54400','77524',
                          '82299','11281','11389','17179','29745',
                          '24744','26615','56963','66772','55048',
                          '49795','52151','74396','31613','88397',
                          '72520','28805','36848','78973','66296',
                          '82434','80550','66945','81653','11474',
                          '85776','31053','22269','12437','61322',
                          '33349','11947','64502','44847','54958',
                          '53619','21476','14906','51638','22348',
                          '51733','14369','99615','85413','18847',
                          '30484','74409','29949','84655','90456',
                          '62935','94602','76507','18023','21530',
                          '82555','84414','61785','27772','52576',
                          '48054','96918','57809','22528','51249',
                          '73941','37546','42756','63460','83740',
                          '43380','75165','39233','81086','39299',
                          '79993','88866','57664','86132','34338',
                          '99446','50538','15426','35934','37826',
                          '57547','74144','92382','61141','36965',
                          '41549','23592','19510','11478','19148',
                          '69160','64216','98591','89056','25544',
                          '28336','29801','20315','19683','23323',
                          '58726','56223','25057','43365','25161',
                          '13181','74243','25032','40679','65100',
                          '25953','82118','95571','74260','54474',
                          '99242','34119','20090','88781','84284',
                          '81066','52878','84662','82574','35083',
                          '86858','24173','14993','95857','17687',
                          '95291','40206','44088','86429','42052',
                          '38235','17169','37357','90675','52319',
                          '36734','86544','26841','91227','15550',
                          '77708','24745','47951','33835','33777',
                          '20722','46115','41120','92717','39744',
                          '23552','83135','38181','25527','67180',
                          '59143','85244','57855','59228','18684',
                          '91118','41029','14051','77913','37121',
                          '68182','45976','47445','98016','33452',
                          '38356','43129','96047','61001','54683',
                          '51373','20169','36454','73103','28299',
                          '76699','63207','61910','24919','52121',
                          '52887','33609','95246','87257','52787',
                          '51762','63975','36096','67373','18959',
                          '46629','54180','31678','11942','99061',
                          '77733','51864','14010','94542','55169',
                          '30419','41628','65285','50916','96576',
                          '11494','15970','63054','91058')
     intersect
      select ca_zip
...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 739 and 739+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'cream' or i_color = 'dark') and 
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-24' as date) 
                  and dateadd(day,30,cast('2002-08-24' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('indian','rose','metallic'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 2
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-02-17' as date) and dateadd(day,60,cast('2000-02-17' as date))
 and i_manufact_id in (869,781,842,715)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Rockbridge County','Prince Edward County','Franklin County','Vernon County','Beltrami County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('2001-04-08' as date))
                    and dateadd(day,30,cast ('2001-04-08' as date))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Union','Oakland','Middletown','Hopewell','Greenville') 
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-05-21','2002-10-09','2002-11-20')))
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Green Acres','Buena Vista')
...
and d_date between '2002-02-15' and 
        dateadd(day,90,cast('2002-02-15' as date))
...
where 
	...
	and d_date between cast('2000-02-03' as date) 
				and dateadd(day,30,cast('2000-02-03' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('brown','lawn','ghost','pale','beige','metallic') and
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 24762 and 24762+28800 
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('SD', 'NY', 'MO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ME', 'IL', 'MI')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('LA', 'NE', 'FL')
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('1999-03-07' as date))
                and dateadd(day,30,cast ('1999-03-07' as date))
 group by
    w_state,i_item_id
...
and cc_county in ('Gogebic County','Fairfield County','Franklin Parish','Wadena County',
                  'Maverick County'
)
and exists (select *
