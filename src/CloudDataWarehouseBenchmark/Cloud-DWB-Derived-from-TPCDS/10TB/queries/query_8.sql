...
set query_group to 'TPC-DS query57.tpl stream.8.1';
...
set query_group to 'TPC-DS query29.tpl stream.8.2';
...
set query_group to 'TPC-DS query24.tpl stream.8.3';
...
set query_group to 'TPC-DS query76.tpl stream.8.4';
...
set query_group to 'TPC-DS query37.tpl stream.8.5';
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and d_date between cast('2001-05-23' as date) and dateadd(day,60,cast('2001-05-23' as date))
 and i_manufact_id in (828,768,782,859)
...
set query_group to 'TPC-DS query66.tpl stream.8.6';
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 22059 and 22059+28800 
...
set query_group to 'TPC-DS query60.tpl stream.8.7';
...
set query_group to 'TPC-DS query98.tpl stream.8.8';
...
where 
	...
	and d_date between cast('2001-02-14' as date) 
				and dateadd(day,30,cast('2001-02-14' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
set query_group to 'TPC-DS query80a.tpl stream.8.9';
...
-- end query 9 in stream 8 using template query80a.tpl
set query_group to 'TPC-DS query12.tpl stream.8.10';
...
set query_group to 'TPC-DS query59.tpl stream.8.11';
...
set query_group to 'TPC-DS query70a.tpl stream.8.12';
...
-- end query 12 in stream 8 using template query70a.tpl
set query_group to 'TPC-DS query91.tpl stream.8.13';
...
set query_group to 'TPC-DS query69.tpl stream.8.14';
...
set query_group to 'TPC-DS query40.tpl stream.8.15';
...
set query_group to 'TPC-DS query2.tpl stream.8.16';
...
set query_group to 'TPC-DS query16.tpl stream.8.17';
...
and cc_county in ('Jackson County','Maverick County','Ziebach County','Gogebic County',
                  'San Miguel County'
)
and exists (select *
...
set query_group to 'TPC-DS query44.tpl stream.8.18';
...
set query_group to 'TPC-DS query5a.tpl stream.8.19';
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-27' as date) 
                  and dateadd(day,14,cast('1998-08-27' as date))
...
-- end query 19 in stream 8 using template query5a.tpl
set query_group to 'TPC-DS query73.tpl stream.8.20';
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Dauphin County','Contra Costa County','Coal County','Hubbard County')
...
set query_group to 'TPC-DS query14a.tpl stream.8.21';
...
-- end query 21 in stream 8 using template query14a.tpl
set query_group to 'TPC-DS query71.tpl stream.8.22';
...
set query_group to 'TPC-DS query3.tpl stream.8.23';
...
set query_group to 'TPC-DS query49.tpl stream.8.24';
...
set query_group to 'TPC-DS query84.tpl stream.8.25';
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Georgetown'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  33089
   and ib_upper_bound   <=  33089 + 50000
...
set query_group to 'TPC-DS query64.tpl stream.8.26';
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('azure','blush','steel','snow','cornsilk','violet') and
...
set query_group to 'TPC-DS query7.tpl stream.8.27';
...
set query_group to 'TPC-DS query36a.tpl stream.8.28';
...
-- end query 28 in stream 8 using template query36a.tpl
set query_group to 'TPC-DS query61.tpl stream.8.29';
...
set query_group to 'TPC-DS query41.tpl stream.8.30';
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 887 and 887+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'seashell' or i_color = 'lime') and
...
set query_group to 'TPC-DS query35.tpl stream.8.31';
...
set query_group to 'TPC-DS query50.tpl stream.8.32';
...
set query_group to 'TPC-DS query65.tpl stream.8.33';
...
set query_group to 'TPC-DS query51.tpl stream.8.34';
...
set query_group to 'TPC-DS query78.tpl stream.8.35';
...
set query_group to 'TPC-DS query21.tpl stream.8.36';
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between dateadd(day,-30,cast ('2000-02-12' as date))
                    and dateadd(day,30,cast ('2000-02-12' as date))
...
set query_group to 'TPC-DS query67a.tpl stream.8.37';
...
-- end query 37 in stream 8 using template query67a.tpl
set query_group to 'TPC-DS query22a.tpl stream.8.38';
...
-- end query 38 in stream 8 using template query22a.tpl
set query_group to 'TPC-DS query81.tpl stream.8.39';
...
set query_group to 'TPC-DS query93.tpl stream.8.40';
...
set query_group to 'TPC-DS query25.tpl stream.8.41';
...
set query_group to 'TPC-DS query26.tpl stream.8.42';
...
set query_group to 'TPC-DS query90.tpl stream.8.43';
...
set query_group to 'TPC-DS query74.tpl stream.8.44';
...
set query_group to 'TPC-DS query92.tpl stream.8.45';
...
set query_group to 'TPC-DS query75.tpl stream.8.46';
...
set query_group to 'TPC-DS query10.tpl stream.8.47';
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Habersham County','Pepin County','Harrison County','Clinton County','Fayette County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
set query_group to 'TPC-DS query58.tpl stream.8.48';
...
set query_group to 'TPC-DS query6.tpl stream.8.49';
...
set query_group to 'TPC-DS query47.tpl stream.8.50';
...
set query_group to 'TPC-DS query30.tpl stream.8.51';
...
set query_group to 'TPC-DS query94.tpl stream.8.52';
...
set query_group to 'TPC-DS query97.tpl stream.8.53';
...
set query_group to 'TPC-DS query55.tpl stream.8.54';
...
set query_group to 'TPC-DS query72.tpl stream.8.55';
...
set query_group to 'TPC-DS query95.tpl stream.8.56';
...
set query_group to 'TPC-DS query86a.tpl stream.8.57';
...
-- end query 57 in stream 8 using template query86a.tpl
set query_group to 'TPC-DS query39.tpl stream.8.58';
...
set query_group to 'TPC-DS query17.tpl stream.8.59';
...
set query_group to 'TPC-DS query42.tpl stream.8.60';
...
set query_group to 'TPC-DS query85.tpl stream.8.61';
...
set query_group to 'TPC-DS query9.tpl stream.8.62';
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 425210102
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 298839949
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 294799973
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 162653384
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 106251780
            then (select avg(ss_ext_tax)
                  from store_sales
...
set query_group to 'TPC-DS query32.tpl stream.8.63';
...
set query_group to 'TPC-DS query34.tpl stream.8.64';
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Raleigh County','Somerset County','Contra Costa County','Harper County',
                           'Arthur County','Warren County','Franklin Parish','Lea County')
...
set query_group to 'TPC-DS query79.tpl stream.8.65';
...
set query_group to 'TPC-DS query54.tpl stream.8.66';
...
set query_group to 'TPC-DS query77a.tpl stream.8.67';
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-06' as date) 
                  and dateadd(day,30,cast('2001-08-06' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- end query 67 in stream 8 using template query77a.tpl
set query_group to 'TPC-DS query45.tpl stream.8.68';
...
set query_group to 'TPC-DS query28.tpl stream.8.69';
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 60 and 60+10 
             or ss_coupon_amt between 15172 and 15172+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 41 and 41+10
          or ss_coupon_amt between 6186 and 6186+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 170 and 170+10
          or ss_coupon_amt between 9678 and 9678+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 48 and 48+10
          or ss_coupon_amt between 3092 and 3092+1000
...
set query_group to 'TPC-DS query89.tpl stream.8.71';
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Men','Home','Music') and
          i_class in ('sports-apparel','glassware','pop')
         )
      or (i_category in ('Electronics','Shoes','Jewelry') and
          i_class in ('cameras','womens','loose stones') 
        ))
group by i_category, i_class, i_brand,
...
set query_group to 'TPC-DS query56.tpl stream.8.72';
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('seashell','powder','aquamarine'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 4
...
set query_group to 'TPC-DS query46.tpl stream.8.73';
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Winchester','Edgewood','Pleasant Valley','Mount Zion','Deerfield') 
...
set query_group to 'TPC-DS query19.tpl stream.8.74';
...
set query_group to 'TPC-DS query62.tpl stream.8.75';
...
set query_group to 'TPC-DS query8.tpl stream.8.76';
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '81328','75088','31035','28714','47387','81826',
                          '56359','99170','37936','68965','12679',
                          '51703','50792','58076','68621','71385',
                          '95222','81154','82100','97804','27549',
                          '83361','86006','16411','23662','92824',
                          '15769','61818','18044','20133','95174',
                          '45965','89578','17887','18628','71742',
                          '63167','43925','66023','94125','93886',
                          '28700','34983','77379','51785','58243',
                          '19748','21138','36852','10665','12180',
                          '10639','34586','32494','27474','27710',
                          '56896','67461','30062','60015','92139',
                          '51095','34290','60824','36312','75166',
                          '77580','12438','80286','61869','25756',
                          '81306','96175','63215','44335','19860',
                          '81135','22432','21585','43234','82813',
                          '28211','87648','60499','30769','55595',
                          '88866','77599','53826','51827','26418',
                          '36816','23264','69063','65266','55700',
                          '86324','47897','71365','82541','73021',
                          '27088','41779','74530','77753','82946',
                          '53671','29661','31930','81470','17481',
                          '25126','31535','48055','29459','88363',
                          '80330','70543','79978','47612','20943',
                          '26299','19776','53324','97451','15906',
                          '21755','21219','54263','55412','22793',
                          '86844','88627','50748','64322','83765',
                          '74648','91138','68268','28888','64706',
                          '69967','33024','71954','49206','50138',
                          '66114','57053','97128','72125','96917',
                          '66950','92515','33772','21615','76563',
                          '83816','76578','72622','98159','54640',
                          '50819','69460','17262','21780','40972',
                          '64552','71192','20790','31942','48392',
                          '22090','75293','38853','58935','10318',
                          '29784','49703','77495','56086','80583',
                          '11981','72766','97410','13181','59759',
                          '38649','98161','36067','72975','13499',
                          '26124','17907','43868','33553','42762',
                          '69252','55579','36628','90484','40598',
                          '35812','63265','62563','11763','43419',
                          '37628','57449','35927','77539','97956',
                          '14609','73059','64642','15490','45430',
                          '78701','76339','47145','42422','59221',
                          '26928','70615','27831','82990','21014',
                          '30022','47579','81096','78209','23201',
                          '52488','90638','45603','37431','34513',
                          '22008','52026','70932','55096','60116',
                          '85819','54873','29129','31725','36348',
                          '12574','48635','52462','86519','58623',
                          '29798','17103','75178','45617','70707',
                          '68693','47797','95109','73651','46836',
                          '82441','92012','76837','13254','20975',
                          '93156','99691','50422','48186','96419',
                          '43283','11796','57010','80425','13013',
                          '35584','55252','15620','72798','92903',
                          '22740','60554','56463','73383','36811',
                          '52201','81816','19852','54506','93413',
                          '39411','94221','79056','57363','56839',
                          '47830','88335','53273','93919','42307',
                          '66358','77823','75493','35456','16521',
                          '82218','46463','67969','40804','14313',
                          '22495','16687','67590','60127','70140',
                          '33559','48346','44329','64087','69135',
                          '69637','69917','35649','36652','91433',
                          '20192','16745','96618','48704','69814',
                          '73348','11350','17458','36473','79130',
                          '88416','45880','30711','46123','38047',
                          '82821','13366','45571','13183','28198',
                          '59483','67426','85487','38238','21537',
                          '37931','74268','11986','32120','61452',
                          '73073','43812','85901','32601','96231',
                          '20085','50305','96119','48891','69776',
                          '16308','48356','11530','75713','99116',
                          '50733','35934','62300','45581','50426',
                          '44469','18686','72304','66592','87641',
                          '72093','25672','23207','33698','83656',
                          '13666','41031','58758','53900','74443',
                          '65572','22339','45493','10554','61829',
                          '79803','70771','20906','28380')
     intersect
      select ca_zip
...
set query_group to 'TPC-DS query96.tpl stream.8.77';
...
set query_group to 'TPC-DS query1.tpl stream.8.78';
...
set query_group to 'TPC-DS query23.tpl stream.8.79';
...
set query_group to 'TPC-DS query88.tpl stream.8.80';
...
set query_group to 'TPC-DS query82.tpl stream.8.81';
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-06-29' as date) and dateadd(day,60,cast('2000-06-29' as date))
 and i_manufact_id in (5,456,254,174)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
set query_group to 'TPC-DS query87.tpl stream.8.82';
...
set query_group to 'TPC-DS query43.tpl stream.8.83';
...
set query_group to 'TPC-DS query53.tpl stream.8.84';
...
set query_group to 'TPC-DS query20.tpl stream.8.85';
select /* TPC-DS query20.tpl 0.65 */  i_item_id
 ...
 and d_date between cast('2000-05-21' as date) 
 				and dateadd(day,30,cast('2000-05-21' as date))
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
set query_group to 'TPC-DS query52.tpl stream.8.86';
...
set query_group to 'TPC-DS query83.tpl stream.8.87';
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-04-30','2001-09-25','2001-11-08')))
...
set query_group to 'TPC-DS query38.tpl stream.8.88';
...
set query_group to 'TPC-DS query68.tpl stream.8.89';
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 9 or
             household_demographics.hd_vehicle_count= -1)
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Four Corners','Mount Vernon')
...
set query_group to 'TPC-DS query4.tpl stream.8.90';
...
set query_group to 'TPC-DS query13.tpl stream.8.91';
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WA', 'KS', 'CA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'VA', 'MD')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'ND', 'IL')
  and ss_net_profit between 50 and 250  
     ))
;

-- end query 91 in stream 8 using template query13.tpl
set query_group to 'TPC-DS query48.tpl stream.8.92';
...
set query_group to 'TPC-DS query99.tpl stream.8.93';
...
set query_group to 'TPC-DS query27a.tpl stream.8.94';
...
-- end query 94 in stream 8 using template query27a.tpl
set query_group to 'TPC-DS query18a.tpl stream.8.95';
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,11,2,5,6,7) and
       d_year = 2001 and
       ca_state in ('NC','LA','CT','NE','TX','WI','GA')
 )
...
-- end query 95 in stream 8 using template query18a.tpl
set query_group to 'TPC-DS query15.tpl stream.8.96';
...
set query_group to 'TPC-DS query33.tpl stream.8.97';
...
set query_group to 'TPC-DS query31.tpl stream.8.98';
...
set query_group to 'TPC-DS query63.tpl stream.8.99';
