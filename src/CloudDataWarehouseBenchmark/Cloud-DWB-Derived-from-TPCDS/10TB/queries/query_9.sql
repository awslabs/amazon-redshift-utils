...
with /* TPC-DS query5a.tpl 0.98 */ ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-25' as date) 
                  and dateadd(day,14,cast('1998-08-25' as date))
...
select /* TPC-DS query84.tpl 0.80 */  c_customer_id as customer_id
 ...
 where ca_city	        =  'Midway'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  51583
   and ib_upper_bound   <=  51583 + 50000
...
select /* TPC-DS query13.tpl 0.91 */ avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_country = 'United States'
  and ca_state in ('MS', 'CA', 'WA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'GA', 'AZ')
...
select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Terry County','Dade County','Raleigh County','Luce County',
                           'Lea County','Pennington County','Adams County','Furnas County')
...
select /* TPC-DS query21.tpl 0.14 */  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between dateadd(day,-30,cast ('1999-04-24' as date))
...
select /* TPC-DS query9.tpl 0.49 */ case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 135370020
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 6855531
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 324737153
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 93815109
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 393328575
            then (select avg(ss_ext_tax)
                  from store_sales
...
where 
	...
	and d_date between cast('2000-01-16' as date) 
				and dateadd(day,30,cast('2000-01-16' as date))
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2001-02-01' and 
        dateadd(day,90,cast('2001-02-01' as date))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 125 and 125+10
          or ss_coupon_amt between 9149 and 9149+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 3 and 3+10
          or ss_coupon_amt between 15546 and 15546+1000
...
with /* TPC-DS query77a.tpl 0.78 */ ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-28' as date) 
                  and dateadd(day,30,cast('2001-08-28' as date))  
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select /* TPC-DS query82.tpl 0.67 */  i_item_id
 ...
 and d_date between cast('2001-05-28' as date) and dateadd(day,60,cast('2001-05-28' as date))
 and i_manufact_id in (791,593,457,868)
...
and cc_county in ('Barrow County','Luce County','Gogebic County','Daviess County',
                  'Walker County'
)
and exists (select *
...
select /* TPC-DS query10.tpl 0.26 */  
 ...
 where
  ...
  ca_county in ('Wagoner County','Queen Anne County','Knox County','Pierce County','Willacy County') and
...
with /* TPC-DS query18a.tpl 0.90 */ results as
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,12,3,2,8,11) and
       d_year = 2002 and
       ca_state in ('NE','GA','IN','FL','IA','ND','MD')
 )
...
select /* TPC-DS query68.tpl 0.95 */  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Cross Roads','Oxford')
...
select /* TPC-DS query40.tpl 0.86 */  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between dateadd(day,-30,cast ('2001-02-22' as date))
                and dateadd(day,30,cast ('2001-02-22' as date))
 group by
    w_state,i_item_id
...
select /* TPC-DS query66.tpl 0.39 */   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 31754 and 31754+28800 
...
select /* TPC-DS query73.tpl 0.79 */ c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('West Feliciana Parish','Henry County','Fairfield County','Cocke County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Books','Children','Women') and
          i_class in ('self-help','school-uniforms','dresses')
         )
      or (i_category in ('Sports','Jewelry','Electronics') and
          i_class in ('optics','pendants','dvd/vcr players') 
        ))
group by i_category, i_class, i_brand,
...
select /* TPC-DS query41.tpl 0.62 */  distinct(i_product_name)
 ...
 where i_manufact_id between 995 and 995+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'seashell' or i_color = 'pale') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'forest' or i_color = 'burnished') and
...
with /* TPC-DS query83.tpl 0.96 */ sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-02-24','2000-08-16','2000-11-05')))
...
select /* TPC-DS query46.tpl 0.23 */  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Wilson','Riverview','White Oak','Pleasant Hill','Farmington') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('lime','slate','linen','firebrick','gainsboro','maroon') and
...
with /* TPC-DS query56.tpl 0.83 */ ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','chartreuse','medium'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 7
...
select /* TPC-DS query37.tpl 0.31 */  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-02-21' as date) and dateadd(day,60,cast('2002-02-21' as date))
 and i_manufact_id in (817,807,857,718)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '37972','19633','33656','51884','66914','56104',
                          '54301','27214','52833','96815','19029',
                          '37947','33346','72174','90664','30888',
                          '56214','58736','94209','38793','52215',
                          '99363','56326','24946','12593','62006',
                          '68160','12854','74748','62808','29459',
                          '81043','22629','14500','73081','20560',
                          '10800','79842','58788','35285','67217',
                          '54326','83685','30644','60527','69976',
                          '96894','23117','91050','29516','83182',
                          '57495','75400','63628','52535','92201',
                          '55072','49831','31562','40047','35592',
                          '60008','14614','31957','40578','20518',
                          '95676','32515','29678','22987','61714',
                          '79863','90830','55736','35818','98806',
                          '72599','60799','65442','82685','83143',
                          '40315','59565','11023','34207','77636',
                          '57401','34496','92848','25338','91406',
                          '70562','70505','86518','61501','87274',
                          '18236','69310','47906','94192','89124',
                          '25419','43666','29319','57250','88782',
                          '60659','35109','32602','81027','27048',
                          '91936','90875','93358','35461','90734',
                          '69888','96545','68295','50411','18180',
                          '56801','92431','25701','18795','89357',
                          '45204','12498','32685','47268','44153',
                          '76031','90475','51955','36979','78116',
                          '49777','61549','96480','51870','31126',
                          '94057','23994','67243','94513','69733',
                          '80678','94322','12433','14911','90914',
                          '72169','57655','15480','18052','12564',
                          '55184','33045','55788','20179','37592',
                          '65725','22675','99998','91759','56571',
                          '10277','15282','26263','51908','68625',
                          '52473','56905','97002','72509','65627',
                          '68346','65677','84870','46112','19778',
                          '53513','46754','31444','21002','28150',
                          '18244','92394','59456','71797','62197',
                          '45202','66617','79822','24057','20788',
                          '62583','26932','49951','21958','68326',
                          '25950','65307','11431','24151','14323',
                          '26282','70545','92632','62714','56119',
                          '97516','88778','70384','64585','70482',
                          '99281','63831','52985','64884','81066',
                          '26780','20652','68652','94685','40274',
                          '79366','97821','50591','33808','10546',
                          '53046','42950','12568','54883','35160',
                          '77097','98370','39924','62356','72245',
                          '32162','63785','89333','19165','46674',
                          '41433','78457','89005','53428','33674',
                          '15532','58578','75844','44738','48697',
                          '84907','79914','95042','33777','15042',
                          '45891','79146','13972','29692','49039',
                          '59266','53314','60574','58450','24816',
                          '51039','53740','25207','72772','84305',
                          '63449','50395','48398','81747','60499',
                          '30478','88947','91502','51930','62729',
                          '73409','42841','19924','23155','46329',
                          '79263','33437','59062','55491','91318',
                          '56826','48532','64446','33860','51709',
                          '82570','60886','74408','75011','49155',
                          '82001','52353','21239','57542','77528',
                          '51213','20122','40692','26972','13743',
                          '50372','29927','73231','50370','47284',
                          '55434','52285','38835','42193','39182',
                          '88194','96041','85501','53754','15671',
                          '84296','32744','27375','85428','72864',
                          '69062','78328','31193','57103','84317',
                          '19427','74871','31441','46691','52249',
                          '91338','16855','32679','80688','69235',
                          '30058','92101','32190','36939','99486',
                          '64890','46904','21138','45364','15444',
                          '67389','89075','30428','31336','43764',
                          '67534','60875','64035','91369','58716',
                          '50205','47782','56433','27179','38533',
                          '24107','80538','90851','16874','96870',
                          '86722','73389','29798','41180','79433',
                          '97906','94962','87882','51137','50987',
                          '49733','72476','71978','86802','76583',
                          '34743','24452','98144','20205')
     intersect
      select ca_zip
